...
namespace aws.Apprunner
{
    ...
    [JsiiByValue(fqn: "aws.apprunner.ApprunnerCustomDomainAssociationConfig")]
    public class ApprunnerCustomDomainAssociationConfig : aws.Apprunner.IApprunnerCustomDomainAssociationConfig
    {
        ...
        [JsiiProperty(name: "serviceArn", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "enableWwwSubdomain", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true, isOverride: true)]
