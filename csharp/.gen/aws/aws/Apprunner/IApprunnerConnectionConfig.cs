...
namespace aws.Apprunner
{
    ...
    [JsiiInterface(nativeType: typeof(IApprunnerConnectionConfig), fullyQualifiedName: "aws.apprunner.ApprunnerConnectionConfig")]
    public interface IApprunnerConnectionConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>App Runner.</summary>
        [JsiiTypeProxy(nativeType: typeof(IApprunnerConnectionConfig), fullyQualifiedName: "aws.apprunner.ApprunnerConnectionConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Apprunner.IApprunnerConnectionConfig
        {
