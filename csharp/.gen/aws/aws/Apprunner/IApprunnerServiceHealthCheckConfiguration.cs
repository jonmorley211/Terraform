...
{
    [JsiiInterface(nativeType: typeof(IApprunnerServiceHealthCheckConfiguration), fullyQualifiedName: "aws.apprunner.ApprunnerServiceHealthCheckConfiguration")]
    public interface IApprunnerServiceHealthCheckConfiguration
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IApprunnerServiceHealthCheckConfiguration), fullyQualifiedName: "aws.apprunner.ApprunnerServiceHealthCheckConfiguration")]
        internal sealed class _Proxy : DeputyBase, aws.Apprunner.IApprunnerServiceHealthCheckConfiguration
        {
