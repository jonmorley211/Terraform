...
{
    [JsiiInterface(nativeType: typeof(IDirectoryServiceDirectoryConnectSettings), fullyQualifiedName: "aws.directoryservice.DirectoryServiceDirectoryConnectSettings")]
    public interface IDirectoryServiceDirectoryConnectSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDirectoryServiceDirectoryConnectSettings), fullyQualifiedName: "aws.directoryservice.DirectoryServiceDirectoryConnectSettings")]
        internal sealed class _Proxy : DeputyBase, aws.Directoryservice.IDirectoryServiceDirectoryConnectSettings
        {
