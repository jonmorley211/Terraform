...
namespace aws.Directoryservice
{
    ...
    public class DirectoryServiceDirectoryConnectSettingsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public DirectoryServiceDirectoryConnectSettingsOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
