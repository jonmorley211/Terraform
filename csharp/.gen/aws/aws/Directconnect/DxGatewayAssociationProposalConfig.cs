...
namespace aws.Directconnect
{
    ...
    public class DxGatewayAssociationProposalConfig : aws.Directconnect.IDxGatewayAssociationProposalConfig
    {
        ...
        [JsiiProperty(name: "associatedGatewayId", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiProperty(name: "dxGatewayOwnerAccountId", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
