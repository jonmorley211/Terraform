...
namespace aws.Directconnect
{
    ...
    [JsiiInterface(nativeType: typeof(IDxHostedConnectionConfig), fullyQualifiedName: "aws.directconnect.DxHostedConnectionConfig")]
    public interface IDxHostedConnectionConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Direct Connect.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDxHostedConnectionConfig), fullyQualifiedName: "aws.directconnect.DxHostedConnectionConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Directconnect.IDxHostedConnectionConfig
        {
