...
namespace aws.Apigateway
{
    ...
    public class ApiGatewayMethodResponseConfig : aws.Apigateway.IApiGatewayMethodResponseConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "responseParameters", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"primitive\":\"boolean\"},\"kind\":\"map\"}}]}}", isOptional: true, isOverride: true)]
