...
namespace aws.Apigateway
{
    ...
    public class ApiGatewayMethodSettingsConfig : aws.Apigateway.IApiGatewayMethodSettingsConfig
    {
        ...
        [JsiiProperty(name: "methodPath", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        /// </remarks>
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"aws.apigateway.ApiGatewayMethodSettingsSettings\"}", isOverride: true)]
