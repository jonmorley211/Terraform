...
namespace aws.Apigateway
{
    ...
    public class ApiGatewayDomainNameEndpointConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ApiGatewayDomainNameEndpointConfigurationOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
