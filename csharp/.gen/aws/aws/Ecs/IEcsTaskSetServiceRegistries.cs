...
namespace aws.Ecs
{
    [JsiiInterface(nativeType: typeof(IEcsTaskSetServiceRegistries), fullyQualifiedName: "aws.ecs.EcsTaskSetServiceRegistries")]
    public interface IEcsTaskSetServiceRegistries
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEcsTaskSetServiceRegistries), fullyQualifiedName: "aws.ecs.EcsTaskSetServiceRegistries")]
        internal sealed class _Proxy : DeputyBase, aws.Ecs.IEcsTaskSetServiceRegistries
        {
