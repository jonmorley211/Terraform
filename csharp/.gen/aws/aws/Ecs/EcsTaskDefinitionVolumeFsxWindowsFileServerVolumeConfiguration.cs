...
namespace aws.Ecs
{
    ...
    [JsiiByValue(fqn: "aws.ecs.EcsTaskDefinitionVolumeFsxWindowsFileServerVolumeConfiguration")]
    public class EcsTaskDefinitionVolumeFsxWindowsFileServerVolumeConfiguration : aws.Ecs.IEcsTaskDefinitionVolumeFsxWindowsFileServerVolumeConfiguration
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "authorizationConfig", typeJson: "{\"fqn\":\"aws.ecs.EcsTaskDefinitionVolumeFsxWindowsFileServerVolumeConfigurationAuthorizationConfig\"}", isOverride: true)]
        ...
        [JsiiProperty(name: "rootDirectory", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
