...
namespace aws.Ecs
{
    [JsiiInterface(nativeType: typeof(IEcsClusterConfigurationExecuteCommandConfigurationLogConfiguration), fullyQualifiedName: "aws.ecs.EcsClusterConfigurationExecuteCommandConfigurationLogConfiguration")]
    public interface IEcsClusterConfigurationExecuteCommandConfigurationLogConfiguration
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEcsClusterConfigurationExecuteCommandConfigurationLogConfiguration), fullyQualifiedName: "aws.ecs.EcsClusterConfigurationExecuteCommandConfigurationLogConfiguration")]
        internal sealed class _Proxy : DeputyBase, aws.Ecs.IEcsClusterConfigurationExecuteCommandConfigurationLogConfiguration
        {
