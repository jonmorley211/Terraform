...
namespace aws.Ecs
{
    [JsiiInterface(nativeType: typeof(IEcsServiceLoadBalancer), fullyQualifiedName: "aws.ecs.EcsServiceLoadBalancer")]
    public interface IEcsServiceLoadBalancer
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEcsServiceLoadBalancer), fullyQualifiedName: "aws.ecs.EcsServiceLoadBalancer")]
        internal sealed class _Proxy : DeputyBase, aws.Ecs.IEcsServiceLoadBalancer
        {
