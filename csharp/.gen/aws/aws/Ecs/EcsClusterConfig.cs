...
namespace aws.Ecs
{
    ...
    public class EcsClusterConfig : aws.Ecs.IEcsClusterConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "capacityProviders", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "configuration", typeJson: "{\"fqn\":\"aws.ecs.EcsClusterConfiguration\"}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "defaultCapacityProviderStrategy", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ecs.EcsClusterDefaultCapacityProviderStrategy\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "setting", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ecs.EcsClusterSetting\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
