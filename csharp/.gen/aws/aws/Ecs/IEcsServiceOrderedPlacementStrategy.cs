...
namespace aws.Ecs
{
    [JsiiInterface(nativeType: typeof(IEcsServiceOrderedPlacementStrategy), fullyQualifiedName: "aws.ecs.EcsServiceOrderedPlacementStrategy")]
    public interface IEcsServiceOrderedPlacementStrategy
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEcsServiceOrderedPlacementStrategy), fullyQualifiedName: "aws.ecs.EcsServiceOrderedPlacementStrategy")]
        internal sealed class _Proxy : DeputyBase, aws.Ecs.IEcsServiceOrderedPlacementStrategy
        {
