...
namespace aws.Fsx
{
    [JsiiInterface(nativeType: typeof(IFsxBackupTimeouts), fullyQualifiedName: "aws.fsx.FsxBackupTimeouts")]
    public interface IFsxBackupTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IFsxBackupTimeouts), fullyQualifiedName: "aws.fsx.FsxBackupTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Fsx.IFsxBackupTimeouts
        {
