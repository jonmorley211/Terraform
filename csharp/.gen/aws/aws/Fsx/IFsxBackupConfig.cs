...
namespace aws.Fsx
{
    ...
    [JsiiInterface(nativeType: typeof(IFsxBackupConfig), fullyQualifiedName: "aws.fsx.FsxBackupConfig")]
    public interface IFsxBackupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.fsx.FsxBackupTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Fsx.IFsxBackupTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        /// <summary>AWS File System FSx.</summary>
        [JsiiTypeProxy(nativeType: typeof(IFsxBackupConfig), fullyQualifiedName: "aws.fsx.FsxBackupConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Fsx.IFsxBackupConfig
        {
