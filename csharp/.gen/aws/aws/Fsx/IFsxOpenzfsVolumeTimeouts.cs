...
namespace aws.Fsx
{
    [JsiiInterface(nativeType: typeof(IFsxOpenzfsVolumeTimeouts), fullyQualifiedName: "aws.fsx.FsxOpenzfsVolumeTimeouts")]
    public interface IFsxOpenzfsVolumeTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IFsxOpenzfsVolumeTimeouts), fullyQualifiedName: "aws.fsx.FsxOpenzfsVolumeTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Fsx.IFsxOpenzfsVolumeTimeouts
        {
