...
namespace aws.Fsx
{
    [JsiiClass(nativeType: typeof(aws.Fsx.FsxOpenzfsVolumeOriginSnapshotOutputReference), fullyQualifiedName: "aws.fsx.FsxOpenzfsVolumeOriginSnapshotOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.ITerraformResource\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"True if this is a block, false if it's a list.\"},\"name\":\"isSingleItem\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class FsxOpenzfsVolumeOriginSnapshotOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public FsxOpenzfsVolumeOriginSnapshotOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.fsx.FsxOpenzfsVolumeOriginSnapshot\"}", isOptional: true)]
        public virtual aws.Fsx.IFsxOpenzfsVolumeOriginSnapshot? InternalValue
        {
