...
namespace aws.Fsx
{
    [JsiiInterface(nativeType: typeof(IFsxOpenzfsSnapshotTimeouts), fullyQualifiedName: "aws.fsx.FsxOpenzfsSnapshotTimeouts")]
    public interface IFsxOpenzfsSnapshotTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IFsxOpenzfsSnapshotTimeouts), fullyQualifiedName: "aws.fsx.FsxOpenzfsSnapshotTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Fsx.IFsxOpenzfsSnapshotTimeouts
        {
