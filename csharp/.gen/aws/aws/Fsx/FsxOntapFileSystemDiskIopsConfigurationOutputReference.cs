...
namespace aws.Fsx
{
    ...
    public class FsxOntapFileSystemDiskIopsConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public FsxOntapFileSystemDiskIopsConfigurationOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.fsx.FsxOntapFileSystemDiskIopsConfiguration\"}", isOptional: true)]
        public virtual aws.Fsx.IFsxOntapFileSystemDiskIopsConfiguration? InternalValue
        {
