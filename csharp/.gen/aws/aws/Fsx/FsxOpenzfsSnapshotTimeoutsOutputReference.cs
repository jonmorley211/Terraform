...
namespace aws.Fsx
{
    ...
    public class FsxOpenzfsSnapshotTimeoutsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public FsxOpenzfsSnapshotTimeoutsOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.fsx.FsxOpenzfsSnapshotTimeouts\"}", isOptional: true)]
        public virtual aws.Fsx.IFsxOpenzfsSnapshotTimeouts? InternalValue
        {
