...
namespace aws.Fsx
{
    ...
    public class FsxOntapStorageVirtualMachineTimeoutsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public FsxOntapStorageVirtualMachineTimeoutsOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.fsx.FsxOntapStorageVirtualMachineTimeouts\"}", isOptional: true)]
        public virtual aws.Fsx.IFsxOntapStorageVirtualMachineTimeouts? InternalValue
        {
