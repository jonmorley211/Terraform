...
namespace aws.Fsx
{
    ...
    public class FsxOntapFileSystemTimeoutsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public FsxOntapFileSystemTimeoutsOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.fsx.FsxOntapFileSystemTimeouts\"}", isOptional: true)]
        public virtual aws.Fsx.IFsxOntapFileSystemTimeouts? InternalValue
        {
