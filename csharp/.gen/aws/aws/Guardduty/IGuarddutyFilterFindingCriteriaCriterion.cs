...
{
    [JsiiInterface(nativeType: typeof(IGuarddutyFilterFindingCriteriaCriterion), fullyQualifiedName: "aws.guardduty.GuarddutyFilterFindingCriteriaCriterion")]
    public interface IGuarddutyFilterFindingCriteriaCriterion
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IGuarddutyFilterFindingCriteriaCriterion), fullyQualifiedName: "aws.guardduty.GuarddutyFilterFindingCriteriaCriterion")]
        internal sealed class _Proxy : DeputyBase, aws.Guardduty.IGuarddutyFilterFindingCriteriaCriterion
        {
