...
namespace aws.Msk
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsMskKafkaVersionConfig), fullyQualifiedName: "aws.msk.DataAwsMskKafkaVersionConfig")]
    public interface IDataAwsMskKafkaVersionConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Managed Streaming for Kafka.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsMskKafkaVersionConfig), fullyQualifiedName: "aws.msk.DataAwsMskKafkaVersionConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Msk.IDataAwsMskKafkaVersionConfig
        {
