...
namespace aws.Ram
{
    ...
    public class RamResourceShareAccepterConfig : aws.Ram.IRamResourceShareAccepterConfig
    {
        ...
        [JsiiProperty(name: "shareArn", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.ram.RamResourceShareAccepterTimeouts\"}", isOptional: true, isOverride: true)]
