...
namespace aws.Ram
{
    ...
    public class RamResourceShareConfig : aws.Ram.IRamResourceShareConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "allowExternalPrincipals", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true, isOverride: true)]
        ...
        /// <summary>Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/ram_resource_share#tags_all RamResourceShare#tags_all}.</summary>
        [JsiiOptional]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.ram.RamResourceShareTimeouts\"}", isOptional: true, isOverride: true)]
