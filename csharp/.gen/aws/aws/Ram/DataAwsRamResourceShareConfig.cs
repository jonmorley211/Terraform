...
namespace aws.Ram
{
    ...
    public class DataAwsRamResourceShareConfig : aws.Ram.IDataAwsRamResourceShareConfig
    {
        ...
        [JsiiProperty(name: "resourceOwner", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ram.DataAwsRamResourceShareFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
