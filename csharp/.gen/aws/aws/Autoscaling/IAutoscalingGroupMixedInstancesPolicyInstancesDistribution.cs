...
{
    [JsiiInterface(nativeType: typeof(IAutoscalingGroupMixedInstancesPolicyInstancesDistribution), fullyQualifiedName: "aws.autoscaling.AutoscalingGroupMixedInstancesPolicyInstancesDistribution")]
    public interface IAutoscalingGroupMixedInstancesPolicyInstancesDistribution
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAutoscalingGroupMixedInstancesPolicyInstancesDistribution), fullyQualifiedName: "aws.autoscaling.AutoscalingGroupMixedInstancesPolicyInstancesDistribution")]
        internal sealed class _Proxy : DeputyBase, aws.Autoscaling.IAutoscalingGroupMixedInstancesPolicyInstancesDistribution
        {
