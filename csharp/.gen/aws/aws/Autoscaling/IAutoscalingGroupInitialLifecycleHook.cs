...
{
    [JsiiInterface(nativeType: typeof(IAutoscalingGroupInitialLifecycleHook), fullyQualifiedName: "aws.autoscaling.AutoscalingGroupInitialLifecycleHook")]
    public interface IAutoscalingGroupInitialLifecycleHook
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAutoscalingGroupInitialLifecycleHook), fullyQualifiedName: "aws.autoscaling.AutoscalingGroupInitialLifecycleHook")]
        internal sealed class _Proxy : DeputyBase, aws.Autoscaling.IAutoscalingGroupInitialLifecycleHook
        {
