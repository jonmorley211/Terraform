...
namespace aws.Rds
{
    [JsiiInterface(nativeType: typeof(IRdsClusterTimeouts), fullyQualifiedName: "aws.rds.RdsClusterTimeouts")]
    public interface IRdsClusterTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRdsClusterTimeouts), fullyQualifiedName: "aws.rds.RdsClusterTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Rds.IRdsClusterTimeouts
        {
