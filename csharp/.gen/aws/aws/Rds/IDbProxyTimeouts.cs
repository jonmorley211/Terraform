...
namespace aws.Rds
{
    [JsiiInterface(nativeType: typeof(IDbProxyTimeouts), fullyQualifiedName: "aws.rds.DbProxyTimeouts")]
    public interface IDbProxyTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDbProxyTimeouts), fullyQualifiedName: "aws.rds.DbProxyTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Rds.IDbProxyTimeouts
        {
