...
namespace aws.Rds
{
    [JsiiInterface(nativeType: typeof(IRdsClusterS3Import), fullyQualifiedName: "aws.rds.RdsClusterS3Import")]
    public interface IRdsClusterS3Import
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRdsClusterS3Import), fullyQualifiedName: "aws.rds.RdsClusterS3Import")]
        internal sealed class _Proxy : DeputyBase, aws.Rds.IRdsClusterS3Import
        {
