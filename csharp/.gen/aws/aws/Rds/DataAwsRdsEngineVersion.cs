...
namespace aws.Rds
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/d/rds_engine_version aws_rds_engine_version}.</summary>
    [JsiiClass(nativeType: typeof(aws.Rds.DataAwsRdsEngineVersion), fullyQualifiedName: "aws.rds.DataAwsRdsEngineVersion", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.rds.DataAwsRdsEngineVersionConfig\"}}]")]
    public class DataAwsRdsEngineVersion : HashiCorp.Cdktf.TerraformDataSource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/d/rds_engine_version aws_rds_engine_version} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataAwsRdsEngineVersion(Constructs.Construct scope, string id, aws.Rds.IDataAwsRdsEngineVersionConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Rds.DataAwsRdsEngineVersion))!;
        ...
        [JsiiProperty(name: "supportsGlobalDatabases", typeJson: "{\"primitive\":\"any\"}")]
        ...
        [JsiiProperty(name: "supportsParallelQuery", typeJson: "{\"primitive\":\"any\"}")]
        public virtual object SupportsParallelQuery
        {
            get => GetInstanceProperty<object>()!;
        }

        [JsiiProperty(name: "supportsReadReplica", typeJson: "{\"primitive\":\"any\"}")]
        public virtual object SupportsReadReplica
        {
            get => GetInstanceProperty<object>()!;
        }
