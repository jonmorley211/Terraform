...
namespace aws.Rds
{
    ...
    public class RdsGlobalCluster : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiMethod(name: "globalClusterMembers", returnsJson: "{\"type\":{\"fqn\":\"aws.rds.RdsGlobalClusterGlobalClusterMembers\"}}", parametersJson: "[{\"name\":\"index\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual aws.Rds.RdsGlobalClusterGlobalClusterMembers GlobalClusterMembers(string index)
        {
            return InvokeInstanceMethod<aws.Rds.RdsGlobalClusterGlobalClusterMembers>(new System.Type[]{typeof(string)}, new object[]{index})!;
        }
