...
namespace aws.Rds
{
    ...
    public interface IDbSecurityGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        aws.Rds.IDbSecurityGroupIngress[] Ingress
        {
            get;
        }
        ...
        /// <summary>Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/db_security_group#tags_all DbSecurityGroup#tags_all}.</summary>
        ...
        internal sealed class _Proxy : DeputyBase, aws.Rds.IDbSecurityGroupConfig
        {
            ...
            /// </remarks>
            [JsiiProperty(name: "ingress", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.rds.DbSecurityGroupIngress\"},\"kind\":\"array\"}}")]
            public aws.Rds.IDbSecurityGroupIngress[] Ingress
            {
