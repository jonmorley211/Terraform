...
namespace aws.Rds
{
    [JsiiInterface(nativeType: typeof(IDbProxyDefaultTargetGroupConnectionPoolConfig), fullyQualifiedName: "aws.rds.DbProxyDefaultTargetGroupConnectionPoolConfig")]
    public interface IDbProxyDefaultTargetGroupConnectionPoolConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDbProxyDefaultTargetGroupConnectionPoolConfig), fullyQualifiedName: "aws.rds.DbProxyDefaultTargetGroupConnectionPoolConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Rds.IDbProxyDefaultTargetGroupConnectionPoolConfig
        {
