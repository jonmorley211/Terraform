...
namespace aws.Rds
{
    [JsiiInterface(nativeType: typeof(IDbInstanceTimeouts), fullyQualifiedName: "aws.rds.DbInstanceTimeouts")]
    public interface IDbInstanceTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDbInstanceTimeouts), fullyQualifiedName: "aws.rds.DbInstanceTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Rds.IDbInstanceTimeouts
        {
