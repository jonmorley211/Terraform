...
namespace aws.Rds
{
    ...
    public interface IRdsClusterParameterGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "parameter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.rds.RdsClusterParameterGroupParameter\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Rds.IRdsClusterParameterGroupParameter[]? Parameter
        {
            get
            {
                return null;
