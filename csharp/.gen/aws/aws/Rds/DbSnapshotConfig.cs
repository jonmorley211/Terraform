...
namespace aws.Rds
{
    ...
    public class DbSnapshotConfig : aws.Rds.IDbSnapshotConfig
    {
        ...
        [JsiiProperty(name: "dbSnapshotIdentifier", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        /// <summary>Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/db_snapshot#tags_all DbSnapshot#tags_all}.</summary>
        [JsiiOptional]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.rds.DbSnapshotTimeouts\"}", isOptional: true, isOverride: true)]
