...
namespace aws.Rds
{
    [JsiiInterface(nativeType: typeof(IDbInstanceS3Import), fullyQualifiedName: "aws.rds.DbInstanceS3Import")]
    public interface IDbInstanceS3Import
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDbInstanceS3Import), fullyQualifiedName: "aws.rds.DbInstanceS3Import")]
        internal sealed class _Proxy : DeputyBase, aws.Rds.IDbInstanceS3Import
        {
