...
{
    [JsiiInterface(nativeType: typeof(IKinesisAnalyticsApplicationOutputsLambda), fullyQualifiedName: "aws.kinesis.KinesisAnalyticsApplicationOutputsLambda")]
    public interface IKinesisAnalyticsApplicationOutputsLambda
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IKinesisAnalyticsApplicationOutputsLambda), fullyQualifiedName: "aws.kinesis.KinesisAnalyticsApplicationOutputsLambda")]
        internal sealed class _Proxy : DeputyBase, aws.Kinesis.IKinesisAnalyticsApplicationOutputsLambda
        {
