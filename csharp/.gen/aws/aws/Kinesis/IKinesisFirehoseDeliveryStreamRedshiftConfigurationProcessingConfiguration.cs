...
namespace aws.Kinesis
{
    ...
    public interface IKinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfiguration
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "processors", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.kinesis.KinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessors\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Kinesis.IKinesisFirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessors[]? Processors
        {
            get
            {
                return null;
