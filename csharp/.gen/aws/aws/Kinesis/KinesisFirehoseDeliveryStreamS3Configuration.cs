...
namespace aws.Kinesis
{
    ...
    public class KinesisFirehoseDeliveryStreamS3Configuration : aws.Kinesis.IKinesisFirehoseDeliveryStreamS3Configuration
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "cloudwatchLoggingOptions", typeJson: "{\"fqn\":\"aws.kinesis.KinesisFirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptions\"}", isOptional: true, isOverride: true)]
