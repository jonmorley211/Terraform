...
namespace aws.Kinesis
{
    ...
    public class KinesisFirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration : aws.Kinesis.IKinesisFirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "cloudwatchLoggingOptions", typeJson: "{\"fqn\":\"aws.kinesis.KinesisFirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions\"}", isOptional: true, isOverride: true)]
