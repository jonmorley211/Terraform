...
namespace aws.Kinesis
{
    ...
    public class KinesisAnalyticsApplicationInputsSchemaRecordFormatMappingParametersCsvOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public KinesisAnalyticsApplicationInputsSchemaRecordFormatMappingParametersCsvOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
