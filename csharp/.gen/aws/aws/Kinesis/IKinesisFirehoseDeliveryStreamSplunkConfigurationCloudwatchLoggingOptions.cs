...
{
    [JsiiInterface(nativeType: typeof(IKinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions), fullyQualifiedName: "aws.kinesis.KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions")]
    public interface IKinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IKinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions), fullyQualifiedName: "aws.kinesis.KinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions")]
        internal sealed class _Proxy : DeputyBase, aws.Kinesis.IKinesisFirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions
        {
