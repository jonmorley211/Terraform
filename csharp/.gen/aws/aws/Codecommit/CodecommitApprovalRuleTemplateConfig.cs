...
namespace aws.Codecommit
{
    ...
    [JsiiByValue(fqn: "aws.codecommit.CodecommitApprovalRuleTemplateConfig")]
    public class CodecommitApprovalRuleTemplateConfig : aws.Codecommit.ICodecommitApprovalRuleTemplateConfig
    {
