...
namespace aws.Glue
{
    [JsiiInterface(nativeType: typeof(IGluePartitionStorageDescriptorColumns), fullyQualifiedName: "aws.glue.GluePartitionStorageDescriptorColumns")]
    public interface IGluePartitionStorageDescriptorColumns
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IGluePartitionStorageDescriptorColumns), fullyQualifiedName: "aws.glue.GluePartitionStorageDescriptorColumns")]
        internal sealed class _Proxy : DeputyBase, aws.Glue.IGluePartitionStorageDescriptorColumns
        {
