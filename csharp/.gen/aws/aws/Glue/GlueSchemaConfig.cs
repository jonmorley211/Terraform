...
namespace aws.Glue
{
    ...
    [JsiiByValue(fqn: "aws.glue.GlueSchemaConfig")]
    public class GlueSchemaConfig : aws.Glue.IGlueSchemaConfig
    {
        ...
        [JsiiProperty(name: "compatibility", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiProperty(name: "dataFormat", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiProperty(name: "schemaDefinition", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiProperty(name: "schemaName", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "registryArn", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
