...
namespace aws.Glue
{
    ...
    [JsiiInterface(nativeType: typeof(IGluePartitionIndexConfig), fullyQualifiedName: "aws.glue.GluePartitionIndexConfig")]
    public interface IGluePartitionIndexConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "partitionIndex", typeJson: "{\"fqn\":\"aws.glue.GluePartitionIndexPartitionIndex\"}")]
        aws.Glue.IGluePartitionIndexPartitionIndex PartitionIndex
        {
            get;
        }
        ...
        /// <summary>AWS Glue.</summary>
        [JsiiTypeProxy(nativeType: typeof(IGluePartitionIndexConfig), fullyQualifiedName: "aws.glue.GluePartitionIndexConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Glue.IGluePartitionIndexConfig
        {
