...
namespace aws.Glue
{
    [JsiiInterface(nativeType: typeof(IGlueMlTransformParametersFindMatchesParameters), fullyQualifiedName: "aws.glue.GlueMlTransformParametersFindMatchesParameters")]
    public interface IGlueMlTransformParametersFindMatchesParameters
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IGlueMlTransformParametersFindMatchesParameters), fullyQualifiedName: "aws.glue.GlueMlTransformParametersFindMatchesParameters")]
        internal sealed class _Proxy : DeputyBase, aws.Glue.IGlueMlTransformParametersFindMatchesParameters
        {
