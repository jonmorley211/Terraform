...
namespace aws.Acm
{
    ...
    [JsiiByValue(fqn: "aws.acm.AcmpcaCertificateConfig")]
    public class AcmpcaCertificateConfig : aws.Acm.IAcmpcaCertificateConfig
    {
        ...
        [JsiiProperty(name: "certificateSigningRequest", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        /// </remarks>
        [JsiiProperty(name: "validity", typeJson: "{\"fqn\":\"aws.acm.AcmpcaCertificateValidity\"}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "templateArn", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
