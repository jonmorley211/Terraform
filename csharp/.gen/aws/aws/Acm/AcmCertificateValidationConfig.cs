...
namespace aws.Acm
{
    ...
    public class AcmCertificateValidationConfig : aws.Acm.IAcmCertificateValidationConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.acm.AcmCertificateValidationTimeouts\"}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "validationRecordFqdns", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
