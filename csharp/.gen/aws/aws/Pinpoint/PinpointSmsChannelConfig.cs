...
namespace aws.Pinpoint
{
    ...
    public class PinpointSmsChannelConfig : aws.Pinpoint.IPinpointSmsChannelConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "senderId", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "shortCode", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
