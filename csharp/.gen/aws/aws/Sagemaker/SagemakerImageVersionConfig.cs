...
namespace aws.Sagemaker
{
    ...
    [JsiiByValue(fqn: "aws.sagemaker.SagemakerImageVersionConfig")]
    public class SagemakerImageVersionConfig : aws.Sagemaker.ISagemakerImageVersionConfig
    {
        ...
        [JsiiProperty(name: "baseImage", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
