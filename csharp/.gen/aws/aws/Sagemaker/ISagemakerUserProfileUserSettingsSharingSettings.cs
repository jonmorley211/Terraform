...
{
    [JsiiInterface(nativeType: typeof(ISagemakerUserProfileUserSettingsSharingSettings), fullyQualifiedName: "aws.sagemaker.SagemakerUserProfileUserSettingsSharingSettings")]
    public interface ISagemakerUserProfileUserSettingsSharingSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISagemakerUserProfileUserSettingsSharingSettings), fullyQualifiedName: "aws.sagemaker.SagemakerUserProfileUserSettingsSharingSettings")]
        internal sealed class _Proxy : DeputyBase, aws.Sagemaker.ISagemakerUserProfileUserSettingsSharingSettings
        {
