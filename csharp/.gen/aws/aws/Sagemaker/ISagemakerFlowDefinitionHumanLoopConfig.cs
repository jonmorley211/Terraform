...
{
    [JsiiInterface(nativeType: typeof(ISagemakerFlowDefinitionHumanLoopConfig), fullyQualifiedName: "aws.sagemaker.SagemakerFlowDefinitionHumanLoopConfig")]
    public interface ISagemakerFlowDefinitionHumanLoopConfig
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "publicWorkforceTaskPrice", typeJson: "{\"fqn\":\"aws.sagemaker.SagemakerFlowDefinitionHumanLoopConfigPublicWorkforceTaskPrice\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Sagemaker.ISagemakerFlowDefinitionHumanLoopConfigPublicWorkforceTaskPrice? PublicWorkforceTaskPrice
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ISagemakerFlowDefinitionHumanLoopConfig), fullyQualifiedName: "aws.sagemaker.SagemakerFlowDefinitionHumanLoopConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Sagemaker.ISagemakerFlowDefinitionHumanLoopConfig
        {
