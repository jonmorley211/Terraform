...
namespace aws.Sagemaker
{
    ...
    public class SagemakerModelVpcConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public SagemakerModelVpcConfigOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
