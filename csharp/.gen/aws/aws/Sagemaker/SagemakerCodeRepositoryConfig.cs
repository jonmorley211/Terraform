...
namespace aws.Sagemaker
{
    ...
    [JsiiByValue(fqn: "aws.sagemaker.SagemakerCodeRepositoryConfig")]
    public class SagemakerCodeRepositoryConfig : aws.Sagemaker.ISagemakerCodeRepositoryConfig
    {
        ...
        [JsiiProperty(name: "codeRepositoryName", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        /// </remarks>
        [JsiiProperty(name: "gitConfig", typeJson: "{\"fqn\":\"aws.sagemaker.SagemakerCodeRepositoryGitConfig\"}", isOverride: true)]
