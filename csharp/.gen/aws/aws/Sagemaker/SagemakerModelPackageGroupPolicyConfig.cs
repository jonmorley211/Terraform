...
namespace aws.Sagemaker
{
    ...
    [JsiiByValue(fqn: "aws.sagemaker.SagemakerModelPackageGroupPolicyConfig")]
    public class SagemakerModelPackageGroupPolicyConfig : aws.Sagemaker.ISagemakerModelPackageGroupPolicyConfig
    {
        ...
        [JsiiProperty(name: "resourcePolicy", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
