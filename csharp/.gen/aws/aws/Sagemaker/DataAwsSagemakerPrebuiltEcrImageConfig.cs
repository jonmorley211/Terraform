...
namespace aws.Sagemaker
{
    ...
    [JsiiByValue(fqn: "aws.sagemaker.DataAwsSagemakerPrebuiltEcrImageConfig")]
    public class DataAwsSagemakerPrebuiltEcrImageConfig : aws.Sagemaker.IDataAwsSagemakerPrebuiltEcrImageConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "dnsSuffix", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
