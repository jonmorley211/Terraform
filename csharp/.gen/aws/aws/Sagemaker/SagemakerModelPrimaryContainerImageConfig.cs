...
namespace aws.Sagemaker
{
    ...
    [JsiiByValue(fqn: "aws.sagemaker.SagemakerModelPrimaryContainerImageConfig")]
    public class SagemakerModelPrimaryContainerImageConfig : aws.Sagemaker.ISagemakerModelPrimaryContainerImageConfig
    {
