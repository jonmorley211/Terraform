...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/codeartifact_repository_permissions_policy aws_codeartifact_repository_permissions_policy}.</summary>
    [JsiiClass(nativeType: typeof(aws.Codeartifact.CodeartifactRepositoryPermissionsPolicy), fullyQualifiedName: "aws.codeartifact.CodeartifactRepositoryPermissionsPolicy", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.codeartifact.CodeartifactRepositoryPermissionsPolicyConfig\"}}]")]
    public class CodeartifactRepositoryPermissionsPolicy : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/codeartifact_repository_permissions_policy aws_codeartifact_repository_permissions_policy} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public CodeartifactRepositoryPermissionsPolicy(Constructs.Construct scope, string id, aws.Codeartifact.ICodeartifactRepositoryPermissionsPolicyConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Codeartifact.CodeartifactRepositoryPermissionsPolicy))!;
