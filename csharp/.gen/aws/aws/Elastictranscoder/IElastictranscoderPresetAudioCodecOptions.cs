...
{
    [JsiiInterface(nativeType: typeof(IElastictranscoderPresetAudioCodecOptions), fullyQualifiedName: "aws.elastictranscoder.ElastictranscoderPresetAudioCodecOptions")]
    public interface IElastictranscoderPresetAudioCodecOptions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IElastictranscoderPresetAudioCodecOptions), fullyQualifiedName: "aws.elastictranscoder.ElastictranscoderPresetAudioCodecOptions")]
        internal sealed class _Proxy : DeputyBase, aws.Elastictranscoder.IElastictranscoderPresetAudioCodecOptions
        {
