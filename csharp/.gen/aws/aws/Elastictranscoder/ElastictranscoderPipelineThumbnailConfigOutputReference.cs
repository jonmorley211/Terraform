...
namespace aws.Elastictranscoder
{
    ...
    public class ElastictranscoderPipelineThumbnailConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ElastictranscoderPipelineThumbnailConfigOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
