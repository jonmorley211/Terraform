...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersNetworkSourcePort), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersNetworkSourcePort")]
    public interface ISecurityhubInsightFiltersNetworkSourcePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersNetworkSourcePort), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersNetworkSourcePort")]
        internal sealed class _Proxy : DeputyBase, aws.Securityhub.ISecurityhubInsightFiltersNetworkSourcePort
        {
