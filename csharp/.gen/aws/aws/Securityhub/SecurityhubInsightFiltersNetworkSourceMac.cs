...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersNetworkSourceMac")]
    public class SecurityhubInsightFiltersNetworkSourceMac : aws.Securityhub.ISecurityhubInsightFiltersNetworkSourceMac
    {
