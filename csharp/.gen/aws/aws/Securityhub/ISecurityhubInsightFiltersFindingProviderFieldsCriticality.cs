...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersFindingProviderFieldsCriticality), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersFindingProviderFieldsCriticality")]
    public interface ISecurityhubInsightFiltersFindingProviderFieldsCriticality
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersFindingProviderFieldsCriticality), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersFindingProviderFieldsCriticality")]
        internal sealed class _Proxy : DeputyBase, aws.Securityhub.ISecurityhubInsightFiltersFindingProviderFieldsCriticality
        {
