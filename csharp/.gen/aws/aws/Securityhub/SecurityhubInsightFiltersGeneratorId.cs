...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersGeneratorId")]
    public class SecurityhubInsightFiltersGeneratorId : aws.Securityhub.ISecurityhubInsightFiltersGeneratorId
    {
