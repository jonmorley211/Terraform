...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersProcessLaunchedAt")]
    public class SecurityhubInsightFiltersProcessLaunchedAt : aws.Securityhub.ISecurityhubInsightFiltersProcessLaunchedAt
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "dateRange", typeJson: "{\"fqn\":\"aws.securityhub.SecurityhubInsightFiltersProcessLaunchedAtDateRange\"}", isOptional: true, isOverride: true)]
