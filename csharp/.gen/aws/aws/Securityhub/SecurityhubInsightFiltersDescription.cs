...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersDescription")]
    public class SecurityhubInsightFiltersDescription : aws.Securityhub.ISecurityhubInsightFiltersDescription
    {
