...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersResourceId")]
    public class SecurityhubInsightFiltersResourceId : aws.Securityhub.ISecurityhubInsightFiltersResourceId
    {
