...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersFirstObservedAt")]
    public class SecurityhubInsightFiltersFirstObservedAt : aws.Securityhub.ISecurityhubInsightFiltersFirstObservedAt
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "dateRange", typeJson: "{\"fqn\":\"aws.securityhub.SecurityhubInsightFiltersFirstObservedAtDateRange\"}", isOptional: true, isOverride: true)]
