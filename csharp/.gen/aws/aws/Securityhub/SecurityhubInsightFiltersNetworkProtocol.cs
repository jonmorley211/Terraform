...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersNetworkProtocol")]
    public class SecurityhubInsightFiltersNetworkProtocol : aws.Securityhub.ISecurityhubInsightFiltersNetworkProtocol
    {
