...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAt")]
    public class SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAt : aws.Securityhub.ISecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAt
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "dateRange", typeJson: "{\"fqn\":\"aws.securityhub.SecurityhubInsightFiltersResourceAwsIamAccessKeyCreatedAtDateRange\"}", isOptional: true, isOverride: true)]
