...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersProcessName")]
    public class SecurityhubInsightFiltersProcessName : aws.Securityhub.ISecurityhubInsightFiltersProcessName
    {
