...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersNoteUpdatedBy")]
    public class SecurityhubInsightFiltersNoteUpdatedBy : aws.Securityhub.ISecurityhubInsightFiltersNoteUpdatedBy
    {
