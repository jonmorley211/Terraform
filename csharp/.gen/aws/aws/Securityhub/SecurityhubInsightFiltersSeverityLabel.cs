...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersSeverityLabel")]
    public class SecurityhubInsightFiltersSeverityLabel : aws.Securityhub.ISecurityhubInsightFiltersSeverityLabel
    {
