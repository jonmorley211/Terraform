...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubOrganizationAdminAccountConfig")]
    public class SecurityhubOrganizationAdminAccountConfig : aws.Securityhub.ISecurityhubOrganizationAdminAccountConfig
    {
