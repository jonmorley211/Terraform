...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersFindingProviderFieldsConfidence), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersFindingProviderFieldsConfidence")]
    public interface ISecurityhubInsightFiltersFindingProviderFieldsConfidence
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersFindingProviderFieldsConfidence), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersFindingProviderFieldsConfidence")]
        internal sealed class _Proxy : DeputyBase, aws.Securityhub.ISecurityhubInsightFiltersFindingProviderFieldsConfidence
        {
