...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersProcessPid")]
    public class SecurityhubInsightFiltersProcessPid : aws.Securityhub.ISecurityhubInsightFiltersProcessPid
    {
