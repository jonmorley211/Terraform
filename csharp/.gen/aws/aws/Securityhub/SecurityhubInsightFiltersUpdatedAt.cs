...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersUpdatedAt")]
    public class SecurityhubInsightFiltersUpdatedAt : aws.Securityhub.ISecurityhubInsightFiltersUpdatedAt
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "dateRange", typeJson: "{\"fqn\":\"aws.securityhub.SecurityhubInsightFiltersUpdatedAtDateRange\"}", isOptional: true, isOverride: true)]
