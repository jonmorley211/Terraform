...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersProcessParentPid), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersProcessParentPid")]
    public interface ISecurityhubInsightFiltersProcessParentPid
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersProcessParentPid), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersProcessParentPid")]
        internal sealed class _Proxy : DeputyBase, aws.Securityhub.ISecurityhubInsightFiltersProcessParentPid
        {
