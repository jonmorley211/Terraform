...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersRecordState")]
    public class SecurityhubInsightFiltersRecordState : aws.Securityhub.ISecurityhubInsightFiltersRecordState
    {
