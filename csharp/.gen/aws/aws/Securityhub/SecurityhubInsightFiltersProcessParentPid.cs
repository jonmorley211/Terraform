...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersProcessParentPid")]
    public class SecurityhubInsightFiltersProcessParentPid : aws.Securityhub.ISecurityhubInsightFiltersProcessParentPid
    {
