...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersResourceRegion")]
    public class SecurityhubInsightFiltersResourceRegion : aws.Securityhub.ISecurityhubInsightFiltersResourceRegion
    {
