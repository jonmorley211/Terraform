...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersUserDefinedValues")]
    public class SecurityhubInsightFiltersUserDefinedValues : aws.Securityhub.ISecurityhubInsightFiltersUserDefinedValues
    {
