...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersNetworkSourceIpv6")]
    public class SecurityhubInsightFiltersNetworkSourceIpv6 : aws.Securityhub.ISecurityhubInsightFiltersNetworkSourceIpv6
    {
