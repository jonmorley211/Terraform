...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersConfidence")]
    public class SecurityhubInsightFiltersConfidence : aws.Securityhub.ISecurityhubInsightFiltersConfidence
    {
