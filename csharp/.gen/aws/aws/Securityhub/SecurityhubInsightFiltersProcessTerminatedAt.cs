...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersProcessTerminatedAt")]
    public class SecurityhubInsightFiltersProcessTerminatedAt : aws.Securityhub.ISecurityhubInsightFiltersProcessTerminatedAt
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "dateRange", typeJson: "{\"fqn\":\"aws.securityhub.SecurityhubInsightFiltersProcessTerminatedAtDateRange\"}", isOptional: true, isOverride: true)]
