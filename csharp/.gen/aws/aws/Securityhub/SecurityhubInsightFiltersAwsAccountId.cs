...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersAwsAccountId")]
    public class SecurityhubInsightFiltersAwsAccountId : aws.Securityhub.ISecurityhubInsightFiltersAwsAccountId
    {
