...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersRelatedFindingsId")]
    public class SecurityhubInsightFiltersRelatedFindingsId : aws.Securityhub.ISecurityhubInsightFiltersRelatedFindingsId
    {
