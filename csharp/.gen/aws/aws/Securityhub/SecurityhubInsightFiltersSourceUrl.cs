...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersSourceUrl")]
    public class SecurityhubInsightFiltersSourceUrl : aws.Securityhub.ISecurityhubInsightFiltersSourceUrl
    {
