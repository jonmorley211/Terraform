...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersProductName")]
    public class SecurityhubInsightFiltersProductName : aws.Securityhub.ISecurityhubInsightFiltersProductName
    {
