...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersLastObservedAt")]
    public class SecurityhubInsightFiltersLastObservedAt : aws.Securityhub.ISecurityhubInsightFiltersLastObservedAt
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "dateRange", typeJson: "{\"fqn\":\"aws.securityhub.SecurityhubInsightFiltersLastObservedAtDateRange\"}", isOptional: true, isOverride: true)]
