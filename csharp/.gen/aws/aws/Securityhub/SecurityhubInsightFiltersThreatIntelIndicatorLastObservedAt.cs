...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersThreatIntelIndicatorLastObservedAt")]
    public class SecurityhubInsightFiltersThreatIntelIndicatorLastObservedAt : aws.Securityhub.ISecurityhubInsightFiltersThreatIntelIndicatorLastObservedAt
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "dateRange", typeJson: "{\"fqn\":\"aws.securityhub.SecurityhubInsightFiltersThreatIntelIndicatorLastObservedAtDateRange\"}", isOptional: true, isOverride: true)]
