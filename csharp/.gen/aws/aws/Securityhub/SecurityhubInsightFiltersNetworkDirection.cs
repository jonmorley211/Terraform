...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersNetworkDirection")]
    public class SecurityhubInsightFiltersNetworkDirection : aws.Securityhub.ISecurityhubInsightFiltersNetworkDirection
    {
