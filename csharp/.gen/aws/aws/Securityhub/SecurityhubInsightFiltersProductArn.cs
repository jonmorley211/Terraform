...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersProductArn")]
    public class SecurityhubInsightFiltersProductArn : aws.Securityhub.ISecurityhubInsightFiltersProductArn
    {
