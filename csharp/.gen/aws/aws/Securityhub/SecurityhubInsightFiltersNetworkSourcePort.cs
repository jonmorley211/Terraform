...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersNetworkSourcePort")]
    public class SecurityhubInsightFiltersNetworkSourcePort : aws.Securityhub.ISecurityhubInsightFiltersNetworkSourcePort
    {
