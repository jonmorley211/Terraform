...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersCriticality), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersCriticality")]
    public interface ISecurityhubInsightFiltersCriticality
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersCriticality), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersCriticality")]
        internal sealed class _Proxy : DeputyBase, aws.Securityhub.ISecurityhubInsightFiltersCriticality
        {
