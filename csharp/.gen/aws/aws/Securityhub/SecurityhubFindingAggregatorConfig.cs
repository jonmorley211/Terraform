...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubFindingAggregatorConfig")]
    public class SecurityhubFindingAggregatorConfig : aws.Securityhub.ISecurityhubFindingAggregatorConfig
    {
        ...
        [JsiiProperty(name: "linkingMode", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "specifiedRegions", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
