...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersTitle")]
    public class SecurityhubInsightFiltersTitle : aws.Securityhub.ISecurityhubInsightFiltersTitle
    {
