...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersResourcePartition")]
    public class SecurityhubInsightFiltersResourcePartition : aws.Securityhub.ISecurityhubInsightFiltersResourcePartition
    {
