...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersComplianceStatus")]
    public class SecurityhubInsightFiltersComplianceStatus : aws.Securityhub.ISecurityhubInsightFiltersComplianceStatus
    {
