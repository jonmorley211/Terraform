...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersProductFields), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersProductFields")]
    public interface ISecurityhubInsightFiltersProductFields
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersProductFields), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersProductFields")]
        internal sealed class _Proxy : DeputyBase, aws.Securityhub.ISecurityhubInsightFiltersProductFields
        {
