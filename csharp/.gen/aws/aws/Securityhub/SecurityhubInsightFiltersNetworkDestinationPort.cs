...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersNetworkDestinationPort")]
    public class SecurityhubInsightFiltersNetworkDestinationPort : aws.Securityhub.ISecurityhubInsightFiltersNetworkDestinationPort
    {
