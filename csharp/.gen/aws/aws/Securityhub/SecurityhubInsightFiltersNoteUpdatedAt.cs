...
{
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersNoteUpdatedAt")]
    public class SecurityhubInsightFiltersNoteUpdatedAt : aws.Securityhub.ISecurityhubInsightFiltersNoteUpdatedAt
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "dateRange", typeJson: "{\"fqn\":\"aws.securityhub.SecurityhubInsightFiltersNoteUpdatedAtDateRange\"}", isOptional: true, isOverride: true)]
