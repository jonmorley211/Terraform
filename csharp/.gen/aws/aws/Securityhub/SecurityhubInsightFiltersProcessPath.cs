...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersProcessPath")]
    public class SecurityhubInsightFiltersProcessPath : aws.Securityhub.ISecurityhubInsightFiltersProcessPath
    {
