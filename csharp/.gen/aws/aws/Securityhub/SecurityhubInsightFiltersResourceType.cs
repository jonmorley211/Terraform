...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersResourceType")]
    public class SecurityhubInsightFiltersResourceType : aws.Securityhub.ISecurityhubInsightFiltersResourceType
    {
