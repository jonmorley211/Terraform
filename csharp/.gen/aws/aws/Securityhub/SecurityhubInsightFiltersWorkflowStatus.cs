...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersWorkflowStatus")]
    public class SecurityhubInsightFiltersWorkflowStatus : aws.Securityhub.ISecurityhubInsightFiltersWorkflowStatus
    {
