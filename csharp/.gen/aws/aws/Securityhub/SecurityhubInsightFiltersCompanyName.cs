...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersCompanyName")]
    public class SecurityhubInsightFiltersCompanyName : aws.Securityhub.ISecurityhubInsightFiltersCompanyName
    {
