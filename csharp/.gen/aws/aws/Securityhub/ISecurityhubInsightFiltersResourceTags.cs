...
{
    [JsiiInterface(nativeType: typeof(ISecurityhubInsightFiltersResourceTags), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersResourceTags")]
    public interface ISecurityhubInsightFiltersResourceTags
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityhubInsightFiltersResourceTags), fullyQualifiedName: "aws.securityhub.SecurityhubInsightFiltersResourceTags")]
        internal sealed class _Proxy : DeputyBase, aws.Securityhub.ISecurityhubInsightFiltersResourceTags
        {
