...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubOrganizationConfigurationConfig")]
    public class SecurityhubOrganizationConfigurationConfig : aws.Securityhub.ISecurityhubOrganizationConfigurationConfig
    {
