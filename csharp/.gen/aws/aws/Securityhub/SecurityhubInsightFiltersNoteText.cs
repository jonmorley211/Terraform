...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersNoteText")]
    public class SecurityhubInsightFiltersNoteText : aws.Securityhub.ISecurityhubInsightFiltersNoteText
    {
