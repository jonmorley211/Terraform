...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubInsightFiltersProductFields")]
    public class SecurityhubInsightFiltersProductFields : aws.Securityhub.ISecurityhubInsightFiltersProductFields
    {
