...
namespace aws.Elasticbeanstalk
{
    ...
    public class ElasticBeanstalkApplicationConfig : aws.Elasticbeanstalk.IElasticBeanstalkApplicationConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "appversionLifecycle", typeJson: "{\"fqn\":\"aws.elasticbeanstalk.ElasticBeanstalkApplicationAppversionLifecycle\"}", isOptional: true, isOverride: true)]
