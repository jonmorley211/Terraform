...
{
    [JsiiInterface(nativeType: typeof(IElasticBeanstalkApplicationAppversionLifecycle), fullyQualifiedName: "aws.elasticbeanstalk.ElasticBeanstalkApplicationAppversionLifecycle")]
    public interface IElasticBeanstalkApplicationAppversionLifecycle
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IElasticBeanstalkApplicationAppversionLifecycle), fullyQualifiedName: "aws.elasticbeanstalk.ElasticBeanstalkApplicationAppversionLifecycle")]
        internal sealed class _Proxy : DeputyBase, aws.Elasticbeanstalk.IElasticBeanstalkApplicationAppversionLifecycle
        {
