...
{
    [JsiiByValue(fqn: "aws.codebuild.CodebuildProjectSecondarySourcesBuildStatusConfig")]
    public class CodebuildProjectSecondarySourcesBuildStatusConfig : aws.Codebuild.ICodebuildProjectSecondarySourcesBuildStatusConfig
    {
