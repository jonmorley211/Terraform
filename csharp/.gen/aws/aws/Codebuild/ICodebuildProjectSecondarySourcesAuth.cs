...
{
    [JsiiInterface(nativeType: typeof(ICodebuildProjectSecondarySourcesAuth), fullyQualifiedName: "aws.codebuild.CodebuildProjectSecondarySourcesAuth")]
    public interface ICodebuildProjectSecondarySourcesAuth
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodebuildProjectSecondarySourcesAuth), fullyQualifiedName: "aws.codebuild.CodebuildProjectSecondarySourcesAuth")]
        internal sealed class _Proxy : DeputyBase, aws.Codebuild.ICodebuildProjectSecondarySourcesAuth
        {
