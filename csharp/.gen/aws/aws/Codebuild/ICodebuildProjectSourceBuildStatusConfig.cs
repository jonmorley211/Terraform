...
{
    [JsiiInterface(nativeType: typeof(ICodebuildProjectSourceBuildStatusConfig), fullyQualifiedName: "aws.codebuild.CodebuildProjectSourceBuildStatusConfig")]
    public interface ICodebuildProjectSourceBuildStatusConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodebuildProjectSourceBuildStatusConfig), fullyQualifiedName: "aws.codebuild.CodebuildProjectSourceBuildStatusConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Codebuild.ICodebuildProjectSourceBuildStatusConfig
        {
