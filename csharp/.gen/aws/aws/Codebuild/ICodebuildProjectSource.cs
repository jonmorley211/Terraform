...
namespace aws.Codebuild
{
    ...
    public interface ICodebuildProjectSource
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "buildStatusConfig", typeJson: "{\"fqn\":\"aws.codebuild.CodebuildProjectSourceBuildStatusConfig\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Codebuild.ICodebuildProjectSourceBuildStatusConfig? BuildStatusConfig
        {
            get
            {
                return null;
