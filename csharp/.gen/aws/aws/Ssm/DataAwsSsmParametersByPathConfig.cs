...
namespace aws.Ssm
{
    ...
    [JsiiByValue(fqn: "aws.ssm.DataAwsSsmParametersByPathConfig")]
    public class DataAwsSsmParametersByPathConfig : aws.Ssm.IDataAwsSsmParametersByPathConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "recursive", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "withDecryption", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true, isOverride: true)]
