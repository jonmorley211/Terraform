...
namespace aws.Ssm
{
    ...
    public class SsmAssociationOutputLocationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public SsmAssociationOutputLocationOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
