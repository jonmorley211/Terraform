...
namespace aws.Ssm
{
    ...
    public class SsmPatchBaselineApprovalRule : aws.Ssm.ISsmPatchBaselineApprovalRule
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "patchFilter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ssm.SsmPatchBaselineApprovalRulePatchFilter\"},\"kind\":\"array\"}}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "approveAfterDays", typeJson: "{\"primitive\":\"number\"}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "approveUntilDate", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "enableNonSecurity", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true, isOverride: true)]
