...
namespace aws.Servicediscovery
{
    ...
    public class ServiceDiscoveryPrivateDnsNamespaceConfig : aws.Servicediscovery.IServiceDiscoveryPrivateDnsNamespaceConfig
    {
        ...
        [JsiiProperty(name: "vpc", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        public string Vpc
        {
            get;
            set;
        ...
        /// <summary>Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/service_discovery_private_dns_namespace#tags_all ServiceDiscoveryPrivateDnsNamespace#tags_all}.</summary>
        [JsiiOptional]
