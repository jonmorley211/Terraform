...
{
    [JsiiInterface(nativeType: typeof(IWorkspacesWorkspaceWorkspaceProperties), fullyQualifiedName: "aws.workspaces.WorkspacesWorkspaceWorkspaceProperties")]
    public interface IWorkspacesWorkspaceWorkspaceProperties
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IWorkspacesWorkspaceWorkspaceProperties), fullyQualifiedName: "aws.workspaces.WorkspacesWorkspaceWorkspaceProperties")]
        internal sealed class _Proxy : DeputyBase, aws.Workspaces.IWorkspacesWorkspaceWorkspaceProperties
        {
