...
namespace aws.Workspaces
{
    ...
    public interface IWorkspacesIpGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "rules", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.workspaces.WorkspacesIpGroupRules\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Workspaces.IWorkspacesIpGroupRules[]? Rules
        {
            get
            {
                return null;
