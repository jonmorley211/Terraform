...
{
    [JsiiInterface(nativeType: typeof(IWorkspacesDirectorySelfServicePermissions), fullyQualifiedName: "aws.workspaces.WorkspacesDirectorySelfServicePermissions")]
    public interface IWorkspacesDirectorySelfServicePermissions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IWorkspacesDirectorySelfServicePermissions), fullyQualifiedName: "aws.workspaces.WorkspacesDirectorySelfServicePermissions")]
        internal sealed class _Proxy : DeputyBase, aws.Workspaces.IWorkspacesDirectorySelfServicePermissions
        {
