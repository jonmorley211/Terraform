...
namespace aws.Workspaces
{
    ...
    public class DataAwsWorkspacesBundle : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiMethod(name: "computeType", returnsJson: "{\"type\":{\"fqn\":\"aws.workspaces.DataAwsWorkspacesBundleComputeType\"}}", parametersJson: "[{\"name\":\"index\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual aws.Workspaces.DataAwsWorkspacesBundleComputeType ComputeType(string index)
        {
            return InvokeInstanceMethod<aws.Workspaces.DataAwsWorkspacesBundleComputeType>(new System.Type[]{typeof(string)}, new object[]{index})!;
        }
        ...
        [JsiiMethod(name: "rootStorage", returnsJson: "{\"type\":{\"fqn\":\"aws.workspaces.DataAwsWorkspacesBundleRootStorage\"}}", parametersJson: "[{\"name\":\"index\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual aws.Workspaces.DataAwsWorkspacesBundleRootStorage RootStorage(string index)
        {
            return InvokeInstanceMethod<aws.Workspaces.DataAwsWorkspacesBundleRootStorage>(new System.Type[]{typeof(string)}, new object[]{index})!;
        }
        ...
        [JsiiMethod(name: "userStorage", returnsJson: "{\"type\":{\"fqn\":\"aws.workspaces.DataAwsWorkspacesBundleUserStorage\"}}", parametersJson: "[{\"name\":\"index\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual aws.Workspaces.DataAwsWorkspacesBundleUserStorage UserStorage(string index)
        {
            return InvokeInstanceMethod<aws.Workspaces.DataAwsWorkspacesBundleUserStorage>(new System.Type[]{typeof(string)}, new object[]{index})!;
        }
