...
{
    [JsiiInterface(nativeType: typeof(IWorkspacesDirectoryWorkspaceCreationProperties), fullyQualifiedName: "aws.workspaces.WorkspacesDirectoryWorkspaceCreationProperties")]
    public interface IWorkspacesDirectoryWorkspaceCreationProperties
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IWorkspacesDirectoryWorkspaceCreationProperties), fullyQualifiedName: "aws.workspaces.WorkspacesDirectoryWorkspaceCreationProperties")]
        internal sealed class _Proxy : DeputyBase, aws.Workspaces.IWorkspacesDirectoryWorkspaceCreationProperties
        {
