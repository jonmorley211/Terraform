...
namespace aws.Iot
{
    ...
    public class IotThingTypeConfig : aws.Iot.IIotThingTypeConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "deprecated", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "properties", typeJson: "{\"fqn\":\"aws.iot.IotThingTypeProperties\"}", isOptional: true, isOverride: true)]
