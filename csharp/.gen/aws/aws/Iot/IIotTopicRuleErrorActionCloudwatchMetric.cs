...
namespace aws.Iot
{
    [JsiiInterface(nativeType: typeof(IIotTopicRuleErrorActionCloudwatchMetric), fullyQualifiedName: "aws.iot.IotTopicRuleErrorActionCloudwatchMetric")]
    public interface IIotTopicRuleErrorActionCloudwatchMetric
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IIotTopicRuleErrorActionCloudwatchMetric), fullyQualifiedName: "aws.iot.IotTopicRuleErrorActionCloudwatchMetric")]
        internal sealed class _Proxy : DeputyBase, aws.Iot.IIotTopicRuleErrorActionCloudwatchMetric
        {
