...
namespace aws.Iot
{
    [JsiiInterface(nativeType: typeof(IIotTopicRuleIotEvents), fullyQualifiedName: "aws.iot.IotTopicRuleIotEvents")]
    public interface IIotTopicRuleIotEvents
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IIotTopicRuleIotEvents), fullyQualifiedName: "aws.iot.IotTopicRuleIotEvents")]
        internal sealed class _Proxy : DeputyBase, aws.Iot.IIotTopicRuleIotEvents
        {
