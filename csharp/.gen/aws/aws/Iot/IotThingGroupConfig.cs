...
namespace aws.Iot
{
    ...
    [JsiiByValue(fqn: "aws.iot.IotThingGroupConfig")]
    public class IotThingGroupConfig : aws.Iot.IIotThingGroupConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "parentGroupName", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "properties", typeJson: "{\"fqn\":\"aws.iot.IotThingGroupProperties\"}", isOptional: true, isOverride: true)]
