...
{
    [JsiiInterface(nativeType: typeof(IGlobalacceleratorAcceleratorAttributes), fullyQualifiedName: "aws.globalaccelerator.GlobalacceleratorAcceleratorAttributes")]
    public interface IGlobalacceleratorAcceleratorAttributes
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IGlobalacceleratorAcceleratorAttributes), fullyQualifiedName: "aws.globalaccelerator.GlobalacceleratorAcceleratorAttributes")]
        internal sealed class _Proxy : DeputyBase, aws.Globalaccelerator.IGlobalacceleratorAcceleratorAttributes
        {
