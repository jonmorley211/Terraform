...
namespace aws.Globalaccelerator
{
    ...
    public interface IGlobalacceleratorAcceleratorConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/globalaccelerator_accelerator#tags_all GlobalacceleratorAccelerator#tags_all}.</summary>
        ...
        /// </remarks>
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.globalaccelerator.GlobalacceleratorAcceleratorTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Globalaccelerator.IGlobalacceleratorAcceleratorTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, aws.Globalaccelerator.IGlobalacceleratorAcceleratorConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.globalaccelerator.GlobalacceleratorAcceleratorTimeouts\"}", isOptional: true)]
            public aws.Globalaccelerator.IGlobalacceleratorAcceleratorTimeouts? Timeouts
            {
