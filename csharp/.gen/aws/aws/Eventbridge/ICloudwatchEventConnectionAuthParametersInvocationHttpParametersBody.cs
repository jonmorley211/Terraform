...
{
    [JsiiInterface(nativeType: typeof(ICloudwatchEventConnectionAuthParametersInvocationHttpParametersBody), fullyQualifiedName: "aws.eventbridge.CloudwatchEventConnectionAuthParametersInvocationHttpParametersBody")]
    public interface ICloudwatchEventConnectionAuthParametersInvocationHttpParametersBody
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICloudwatchEventConnectionAuthParametersInvocationHttpParametersBody), fullyQualifiedName: "aws.eventbridge.CloudwatchEventConnectionAuthParametersInvocationHttpParametersBody")]
        internal sealed class _Proxy : DeputyBase, aws.Eventbridge.ICloudwatchEventConnectionAuthParametersInvocationHttpParametersBody
        {
