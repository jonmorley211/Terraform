...
{
    [JsiiInterface(nativeType: typeof(ICloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBody), fullyQualifiedName: "aws.eventbridge.CloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBody")]
    public interface ICloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBody
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBody), fullyQualifiedName: "aws.eventbridge.CloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBody")]
        internal sealed class _Proxy : DeputyBase, aws.Eventbridge.ICloudwatchEventConnectionAuthParametersOauthOauthHttpParametersBody
        {
