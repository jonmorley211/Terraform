...
namespace aws.Lakeformation
{
    ...
    [JsiiByValue(fqn: "aws.lakeformation.LakeformationPermissionsTableWithColumns")]
    public class LakeformationPermissionsTableWithColumns : aws.Lakeformation.ILakeformationPermissionsTableWithColumns
    {
