...
{
    [JsiiInterface(nativeType: typeof(IDataAwsLakeformationPermissionsTableWithColumns), fullyQualifiedName: "aws.lakeformation.DataAwsLakeformationPermissionsTableWithColumns")]
    public interface IDataAwsLakeformationPermissionsTableWithColumns
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsLakeformationPermissionsTableWithColumns), fullyQualifiedName: "aws.lakeformation.DataAwsLakeformationPermissionsTableWithColumns")]
        internal sealed class _Proxy : DeputyBase, aws.Lakeformation.IDataAwsLakeformationPermissionsTableWithColumns
        {
