...
{
    [JsiiInterface(nativeType: typeof(IDataAwsLakeformationPermissionsTable), fullyQualifiedName: "aws.lakeformation.DataAwsLakeformationPermissionsTable")]
    public interface IDataAwsLakeformationPermissionsTable
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsLakeformationPermissionsTable), fullyQualifiedName: "aws.lakeformation.DataAwsLakeformationPermissionsTable")]
        internal sealed class _Proxy : DeputyBase, aws.Lakeformation.IDataAwsLakeformationPermissionsTable
        {
