...
{
    [JsiiInterface(nativeType: typeof(ILakeformationPermissionsDataLocation), fullyQualifiedName: "aws.lakeformation.LakeformationPermissionsDataLocation")]
    public interface ILakeformationPermissionsDataLocation
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILakeformationPermissionsDataLocation), fullyQualifiedName: "aws.lakeformation.LakeformationPermissionsDataLocation")]
        internal sealed class _Proxy : DeputyBase, aws.Lakeformation.ILakeformationPermissionsDataLocation
        {
