...
namespace aws.Lambdafunction
{
    ...
    public class DataAwsLambdaLayerVersionConfig : aws.Lambdafunction.IDataAwsLambdaLayerVersionConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "compatibleArchitecture", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "compatibleRuntime", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "version", typeJson: "{\"primitive\":\"number\"}", isOptional: true, isOverride: true)]
