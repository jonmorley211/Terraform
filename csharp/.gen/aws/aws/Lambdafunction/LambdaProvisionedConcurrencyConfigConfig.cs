...
namespace aws.Lambdafunction
{
    ...
    public class LambdaProvisionedConcurrencyConfigConfig : aws.Lambdafunction.ILambdaProvisionedConcurrencyConfigConfig
    {
        ...
        [JsiiProperty(name: "provisionedConcurrentExecutions", typeJson: "{\"primitive\":\"number\"}", isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.lambdafunction.LambdaProvisionedConcurrencyConfigTimeouts\"}", isOptional: true, isOverride: true)]
