...
namespace aws.Ecr
{
    ...
    public class EcrRepositoryImageScanningConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public EcrRepositoryImageScanningConfigurationOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
