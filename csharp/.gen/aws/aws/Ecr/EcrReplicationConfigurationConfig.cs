...
namespace aws.Ecr
{
    ...
    [JsiiByValue(fqn: "aws.ecr.EcrReplicationConfigurationConfig")]
    public class EcrReplicationConfigurationConfig : aws.Ecr.IEcrReplicationConfigurationConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "replicationConfiguration", typeJson: "{\"fqn\":\"aws.ecr.EcrReplicationConfigurationReplicationConfiguration\"}", isOptional: true, isOverride: true)]
