...
namespace aws.Elb
{
    [JsiiClass(nativeType: typeof(aws.Elb.DataAwsLbListenerDefaultActionAuthenticateOidc), fullyQualifiedName: "aws.elb.DataAwsLbListenerDefaultActionAuthenticateOidc", parametersJson: "[{\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.ITerraformResource\"}},{\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"complexComputedListIndex\",\"type\":{\"primitive\":\"string\"}}]")]
    public class DataAwsLbListenerDefaultActionAuthenticateOidc : HashiCorp.Cdktf.ComplexComputedList
    {
        /// <remarks>
        /// <strong>Stability</strong>: Experimental
        /// </remarks>
        public DataAwsLbListenerDefaultActionAuthenticateOidc(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, string complexComputedListIndex): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, complexComputedListIndex}))
        {
        }
        ...
        protected DataAwsLbListenerDefaultActionAuthenticateOidc(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataAwsLbListenerDefaultActionAuthenticateOidc(DeputyProps props): base(props)
        {
        }
