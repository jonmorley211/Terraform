...
namespace aws.Elb
{
    [JsiiInterface(nativeType: typeof(ILbTimeouts), fullyQualifiedName: "aws.elb.LbTimeouts")]
    public interface ILbTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILbTimeouts), fullyQualifiedName: "aws.elb.LbTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.ILbTimeouts
        {
