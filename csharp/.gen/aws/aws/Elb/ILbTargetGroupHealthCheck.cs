...
namespace aws.Elb
{
    [JsiiInterface(nativeType: typeof(ILbTargetGroupHealthCheck), fullyQualifiedName: "aws.elb.LbTargetGroupHealthCheck")]
    public interface ILbTargetGroupHealthCheck
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILbTargetGroupHealthCheck), fullyQualifiedName: "aws.elb.LbTargetGroupHealthCheck")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.ILbTargetGroupHealthCheck
        {
