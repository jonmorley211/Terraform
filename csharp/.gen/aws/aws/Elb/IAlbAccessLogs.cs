...
namespace aws.Elb
{
    [JsiiInterface(nativeType: typeof(IAlbAccessLogs), fullyQualifiedName: "aws.elb.AlbAccessLogs")]
    public interface IAlbAccessLogs
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbAccessLogs), fullyQualifiedName: "aws.elb.AlbAccessLogs")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.IAlbAccessLogs
        {
