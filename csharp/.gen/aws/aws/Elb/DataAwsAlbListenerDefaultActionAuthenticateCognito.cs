...
namespace aws.Elb
{
    [JsiiClass(nativeType: typeof(aws.Elb.DataAwsAlbListenerDefaultActionAuthenticateCognito), fullyQualifiedName: "aws.elb.DataAwsAlbListenerDefaultActionAuthenticateCognito", parametersJson: "[{\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.ITerraformResource\"}},{\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"complexComputedListIndex\",\"type\":{\"primitive\":\"string\"}}]")]
    public class DataAwsAlbListenerDefaultActionAuthenticateCognito : HashiCorp.Cdktf.ComplexComputedList
    {
        /// <remarks>
        /// <strong>Stability</strong>: Experimental
        /// </remarks>
        public DataAwsAlbListenerDefaultActionAuthenticateCognito(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, string complexComputedListIndex): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, complexComputedListIndex}))
        {
        }
        ...
        protected DataAwsAlbListenerDefaultActionAuthenticateCognito(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataAwsAlbListenerDefaultActionAuthenticateCognito(DeputyProps props): base(props)
        {
        }
