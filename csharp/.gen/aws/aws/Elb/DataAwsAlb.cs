...
namespace aws.Elb
{
    ...
    public class DataAwsAlb : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiMethod(name: "accessLogs", returnsJson: "{\"type\":{\"fqn\":\"aws.elb.DataAwsAlbAccessLogs\"}}", parametersJson: "[{\"name\":\"index\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual aws.Elb.DataAwsAlbAccessLogs AccessLogs(string index)
        {
            return InvokeInstanceMethod<aws.Elb.DataAwsAlbAccessLogs>(new System.Type[]{typeof(string)}, new object[]{index})!;
        }
        ...
        [JsiiMethod(name: "subnetMapping", returnsJson: "{\"type\":{\"fqn\":\"aws.elb.DataAwsAlbSubnetMapping\"}}", parametersJson: "[{\"name\":\"index\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual aws.Elb.DataAwsAlbSubnetMapping SubnetMapping(string index)
        {
            return InvokeInstanceMethod<aws.Elb.DataAwsAlbSubnetMapping>(new System.Type[]{typeof(string)}, new object[]{index})!;
        }
