...
namespace aws.Elb
{
    ...
    public class Lb : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "subnetMappingInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.elb.LbSubnetMapping\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Elb.ILbSubnetMapping[]? SubnetMappingInput
        {
        ...
        [JsiiProperty(name: "subnetMapping", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.elb.LbSubnetMapping\"},\"kind\":\"array\"}}")]
        public virtual aws.Elb.ILbSubnetMapping[] SubnetMapping
        {
            get => GetInstanceProperty<aws.Elb.ILbSubnetMapping[]>()!;
            set => SetInstanceProperty(value);
        }
