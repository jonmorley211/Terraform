...
namespace aws.Elb
{
    [JsiiInterface(nativeType: typeof(ILbListenerDefaultActionForwardStickiness), fullyQualifiedName: "aws.elb.LbListenerDefaultActionForwardStickiness")]
    public interface ILbListenerDefaultActionForwardStickiness
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILbListenerDefaultActionForwardStickiness), fullyQualifiedName: "aws.elb.LbListenerDefaultActionForwardStickiness")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.ILbListenerDefaultActionForwardStickiness
        {
