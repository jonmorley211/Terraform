...
namespace aws.Elb
{
    ...
    public class LbListenerRuleActionRedirectOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LbListenerRuleActionRedirectOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
