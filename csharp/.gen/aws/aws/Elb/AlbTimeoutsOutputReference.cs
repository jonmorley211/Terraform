...
namespace aws.Elb
{
    ...
    public class AlbTimeoutsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public AlbTimeoutsOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
