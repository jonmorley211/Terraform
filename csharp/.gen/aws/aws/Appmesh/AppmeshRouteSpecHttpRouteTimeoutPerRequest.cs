...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshRouteSpecHttpRouteTimeoutPerRequest")]
    public class AppmeshRouteSpecHttpRouteTimeoutPerRequest : aws.Appmesh.IAppmeshRouteSpecHttpRouteTimeoutPerRequest
    {
