...
{
    [JsiiInterface(nativeType: typeof(IAppmeshVirtualGatewaySpecListenerHealthCheck), fullyQualifiedName: "aws.appmesh.AppmeshVirtualGatewaySpecListenerHealthCheck")]
    public interface IAppmeshVirtualGatewaySpecListenerHealthCheck
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppmeshVirtualGatewaySpecListenerHealthCheck), fullyQualifiedName: "aws.appmesh.AppmeshVirtualGatewaySpecListenerHealthCheck")]
        internal sealed class _Proxy : DeputyBase, aws.Appmesh.IAppmeshVirtualGatewaySpecListenerHealthCheck
        {
