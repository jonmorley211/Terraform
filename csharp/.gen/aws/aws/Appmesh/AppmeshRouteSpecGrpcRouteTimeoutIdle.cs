...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutIdle")]
    public class AppmeshRouteSpecGrpcRouteTimeoutIdle : aws.Appmesh.IAppmeshRouteSpecGrpcRouteTimeoutIdle
    {
