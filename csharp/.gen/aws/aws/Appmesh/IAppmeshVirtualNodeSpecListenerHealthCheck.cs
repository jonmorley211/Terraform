...
{
    [JsiiInterface(nativeType: typeof(IAppmeshVirtualNodeSpecListenerHealthCheck), fullyQualifiedName: "aws.appmesh.AppmeshVirtualNodeSpecListenerHealthCheck")]
    public interface IAppmeshVirtualNodeSpecListenerHealthCheck
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppmeshVirtualNodeSpecListenerHealthCheck), fullyQualifiedName: "aws.appmesh.AppmeshVirtualNodeSpecListenerHealthCheck")]
        internal sealed class _Proxy : DeputyBase, aws.Appmesh.IAppmeshVirtualNodeSpecListenerHealthCheck
        {
