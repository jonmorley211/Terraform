...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshVirtualNodeSpecListenerTimeoutTcpIdle")]
    public class AppmeshVirtualNodeSpecListenerTimeoutTcpIdle : aws.Appmesh.IAppmeshVirtualNodeSpecListenerTimeoutTcpIdle
    {
