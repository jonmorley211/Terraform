...
{
    [JsiiByValue(fqn: "aws.appmesh.AppmeshRouteSpecGrpcRouteMatchMetadataMatch")]
    public class AppmeshRouteSpecGrpcRouteMatchMetadataMatch : aws.Appmesh.IAppmeshRouteSpecGrpcRouteMatchMetadataMatch
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "range", typeJson: "{\"fqn\":\"aws.appmesh.AppmeshRouteSpecGrpcRouteMatchMetadataMatchRange\"}", isOptional: true, isOverride: true)]
