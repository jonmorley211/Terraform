...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshGatewayRouteConfig")]
    public class AppmeshGatewayRouteConfig : aws.Appmesh.IAppmeshGatewayRouteConfig
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "spec", typeJson: "{\"fqn\":\"aws.appmesh.AppmeshGatewayRouteSpec\"}", isOverride: true)]
        ...
        [JsiiProperty(name: "virtualGatewayName", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
