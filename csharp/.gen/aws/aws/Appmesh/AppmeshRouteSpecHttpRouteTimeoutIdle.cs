...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshRouteSpecHttpRouteTimeoutIdle")]
    public class AppmeshRouteSpecHttpRouteTimeoutIdle : aws.Appmesh.IAppmeshRouteSpecHttpRouteTimeoutIdle
    {
