...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshVirtualNodeSpecListenerTimeoutGrpcIdle")]
    public class AppmeshVirtualNodeSpecListenerTimeoutGrpcIdle : aws.Appmesh.IAppmeshVirtualNodeSpecListenerTimeoutGrpcIdle
    {
