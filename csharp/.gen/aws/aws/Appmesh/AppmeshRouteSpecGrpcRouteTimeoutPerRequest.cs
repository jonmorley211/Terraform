...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshRouteSpecGrpcRouteTimeoutPerRequest")]
    public class AppmeshRouteSpecGrpcRouteTimeoutPerRequest : aws.Appmesh.IAppmeshRouteSpecGrpcRouteTimeoutPerRequest
    {
