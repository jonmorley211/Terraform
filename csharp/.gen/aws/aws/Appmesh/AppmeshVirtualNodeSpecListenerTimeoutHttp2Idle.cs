...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshVirtualNodeSpecListenerTimeoutHttp2Idle")]
    public class AppmeshVirtualNodeSpecListenerTimeoutHttp2Idle : aws.Appmesh.IAppmeshVirtualNodeSpecListenerTimeoutHttp2Idle
    {
