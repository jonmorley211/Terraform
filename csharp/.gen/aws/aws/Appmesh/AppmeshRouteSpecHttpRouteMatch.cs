...
namespace aws.Appmesh
{
    ...
    public class AppmeshRouteSpecHttpRouteMatch : aws.Appmesh.IAppmeshRouteSpecHttpRouteMatch
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "header", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.appmesh.AppmeshRouteSpecHttpRouteMatchHeader\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
