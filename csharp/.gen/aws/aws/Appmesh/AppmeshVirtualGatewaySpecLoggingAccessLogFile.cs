...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshVirtualGatewaySpecLoggingAccessLogFile")]
    public class AppmeshVirtualGatewaySpecLoggingAccessLogFile : aws.Appmesh.IAppmeshVirtualGatewaySpecLoggingAccessLogFile
    {
