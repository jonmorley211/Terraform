...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshRouteSpecHttp2RouteTimeoutIdle")]
    public class AppmeshRouteSpecHttp2RouteTimeoutIdle : aws.Appmesh.IAppmeshRouteSpecHttp2RouteTimeoutIdle
    {
