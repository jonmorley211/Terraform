...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshGatewayRouteSpecHttpRouteMatch")]
    public class AppmeshGatewayRouteSpecHttpRouteMatch : aws.Appmesh.IAppmeshGatewayRouteSpecHttpRouteMatch
    {
