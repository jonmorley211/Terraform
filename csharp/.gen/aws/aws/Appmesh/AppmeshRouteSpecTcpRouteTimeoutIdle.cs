...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshRouteSpecTcpRouteTimeoutIdle")]
    public class AppmeshRouteSpecTcpRouteTimeoutIdle : aws.Appmesh.IAppmeshRouteSpecTcpRouteTimeoutIdle
    {
