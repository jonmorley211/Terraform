...
namespace aws.Datasources
{
    ...
    public class LaunchConfigurationRootBlockDeviceOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LaunchConfigurationRootBlockDeviceOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
