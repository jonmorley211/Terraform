...
namespace aws.Datasources
{
    ...
    public class DataAwsPrefixListConfig : aws.Datasources.IDataAwsPrefixListConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.datasources.DataAwsPrefixListFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "prefixListId", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
