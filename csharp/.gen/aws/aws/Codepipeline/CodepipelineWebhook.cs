...
namespace aws.Codepipeline
{
    ...
    public class CodepipelineWebhook : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "filterInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.codepipeline.CodepipelineWebhookFilter\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Codepipeline.ICodepipelineWebhookFilter[]? FilterInput
        {
        ...
        public virtual aws.Codepipeline.ICodepipelineWebhookFilter[] Filter
        {
            get => GetInstanceProperty<aws.Codepipeline.ICodepipelineWebhookFilter[]>()!;
            set => SetInstanceProperty(value);
        }
