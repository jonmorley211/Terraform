...
namespace aws.Mq
{
    [JsiiInterface(nativeType: typeof(IMqBrokerLdapServerMetadata), fullyQualifiedName: "aws.mq.MqBrokerLdapServerMetadata")]
    public interface IMqBrokerLdapServerMetadata
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IMqBrokerLdapServerMetadata), fullyQualifiedName: "aws.mq.MqBrokerLdapServerMetadata")]
        internal sealed class _Proxy : DeputyBase, aws.Mq.IMqBrokerLdapServerMetadata
        {
