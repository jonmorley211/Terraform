...
namespace aws.Mwaa
{
    [JsiiByValue(fqn: "aws.mwaa.MwaaEnvironmentLoggingConfigurationTaskLogs")]
    public class MwaaEnvironmentLoggingConfigurationTaskLogs : aws.Mwaa.IMwaaEnvironmentLoggingConfigurationTaskLogs
    {
