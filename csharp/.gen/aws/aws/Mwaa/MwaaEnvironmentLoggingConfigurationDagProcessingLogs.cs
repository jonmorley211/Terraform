...
namespace aws.Mwaa
{
    [JsiiByValue(fqn: "aws.mwaa.MwaaEnvironmentLoggingConfigurationDagProcessingLogs")]
    public class MwaaEnvironmentLoggingConfigurationDagProcessingLogs : aws.Mwaa.IMwaaEnvironmentLoggingConfigurationDagProcessingLogs
    {
