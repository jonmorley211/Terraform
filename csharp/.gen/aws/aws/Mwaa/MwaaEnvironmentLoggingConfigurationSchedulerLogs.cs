...
namespace aws.Mwaa
{
    [JsiiByValue(fqn: "aws.mwaa.MwaaEnvironmentLoggingConfigurationSchedulerLogs")]
    public class MwaaEnvironmentLoggingConfigurationSchedulerLogs : aws.Mwaa.IMwaaEnvironmentLoggingConfigurationSchedulerLogs
    {
