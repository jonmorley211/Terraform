...
namespace aws.Mwaa
{
    [JsiiByValue(fqn: "aws.mwaa.MwaaEnvironmentLoggingConfigurationWebserverLogs")]
    public class MwaaEnvironmentLoggingConfigurationWebserverLogs : aws.Mwaa.IMwaaEnvironmentLoggingConfigurationWebserverLogs
    {
