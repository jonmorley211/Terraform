...
namespace aws.Redshift
{
    ...
    public class RedshiftScheduledActionTargetActionPauseClusterOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public RedshiftScheduledActionTargetActionPauseClusterOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.redshift.RedshiftScheduledActionTargetActionPauseCluster\"}", isOptional: true)]
        public virtual aws.Redshift.IRedshiftScheduledActionTargetActionPauseCluster? InternalValue
        {
