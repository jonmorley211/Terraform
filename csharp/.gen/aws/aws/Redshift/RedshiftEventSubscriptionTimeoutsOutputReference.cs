...
namespace aws.Redshift
{
    ...
    public class RedshiftEventSubscriptionTimeoutsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public RedshiftEventSubscriptionTimeoutsOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
