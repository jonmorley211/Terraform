...
{
    [JsiiInterface(nativeType: typeof(IRoute53RecoveryreadinessResourceSetResources), fullyQualifiedName: "aws.route53.Route53RecoveryreadinessResourceSetResources")]
    public interface IRoute53RecoveryreadinessResourceSetResources
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "dnsTargetResource", typeJson: "{\"fqn\":\"aws.route53.Route53RecoveryreadinessResourceSetResourcesDnsTargetResource\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Route53.IRoute53RecoveryreadinessResourceSetResourcesDnsTargetResource? DnsTargetResource
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IRoute53RecoveryreadinessResourceSetResources), fullyQualifiedName: "aws.route53.Route53RecoveryreadinessResourceSetResources")]
        internal sealed class _Proxy : DeputyBase, aws.Route53.IRoute53RecoveryreadinessResourceSetResources
        {
