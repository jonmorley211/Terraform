...
namespace aws.Route53
{
    ...
    [JsiiInterface(nativeType: typeof(IRoute53RecoveryreadinessReadinessCheckConfig), fullyQualifiedName: "aws.route53.Route53RecoveryreadinessReadinessCheckConfig")]
    public interface IRoute53RecoveryreadinessReadinessCheckConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.route53.Route53RecoveryreadinessReadinessCheckTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Route53.IRoute53RecoveryreadinessReadinessCheckTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        /// <summary>AWS Route 53.</summary>
        [JsiiTypeProxy(nativeType: typeof(IRoute53RecoveryreadinessReadinessCheckConfig), fullyQualifiedName: "aws.route53.Route53RecoveryreadinessReadinessCheckConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Route53.IRoute53RecoveryreadinessReadinessCheckConfig
        {
