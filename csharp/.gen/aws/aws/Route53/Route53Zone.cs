...
namespace aws.Route53
{
    ...
    public class Route53Zone : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "vpcInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.route53.Route53ZoneVpc\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Route53.IRoute53ZoneVpc[]? VpcInput
        {
            get => GetInstanceProperty<aws.Route53.IRoute53ZoneVpc[]?>();
        }
        ...
        [JsiiProperty(name: "vpc", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.route53.Route53ZoneVpc\"},\"kind\":\"array\"}}")]
        public virtual aws.Route53.IRoute53ZoneVpc[] Vpc
        {
            get => GetInstanceProperty<aws.Route53.IRoute53ZoneVpc[]>()!;
            set => SetInstanceProperty(value);
        }
