...
namespace aws.Route53
{
    ...
    public class Route53ResolverRuleAssociationConfig : aws.Route53.IRoute53ResolverRuleAssociationConfig
    {
        ...
        [JsiiProperty(name: "resolverRuleId", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.route53.Route53ResolverRuleAssociationTimeouts\"}", isOptional: true, isOverride: true)]
