...
namespace aws.Route53
{
    ...
    public class Route53ResolverRuleAssociationTimeoutsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public Route53ResolverRuleAssociationTimeoutsOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
