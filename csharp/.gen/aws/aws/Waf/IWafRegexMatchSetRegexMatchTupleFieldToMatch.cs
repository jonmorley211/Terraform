...
namespace aws.Waf
{
    [JsiiInterface(nativeType: typeof(IWafRegexMatchSetRegexMatchTupleFieldToMatch), fullyQualifiedName: "aws.waf.WafRegexMatchSetRegexMatchTupleFieldToMatch")]
    public interface IWafRegexMatchSetRegexMatchTupleFieldToMatch
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IWafRegexMatchSetRegexMatchTupleFieldToMatch), fullyQualifiedName: "aws.waf.WafRegexMatchSetRegexMatchTupleFieldToMatch")]
        internal sealed class _Proxy : DeputyBase, aws.Waf.IWafRegexMatchSetRegexMatchTupleFieldToMatch
        {
