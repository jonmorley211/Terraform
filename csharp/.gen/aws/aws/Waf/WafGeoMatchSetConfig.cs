...
namespace aws.Waf
{
    ...
    public class WafGeoMatchSetConfig : aws.Waf.IWafGeoMatchSetConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "geoMatchConstraint", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.waf.WafGeoMatchSetGeoMatchConstraint\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
