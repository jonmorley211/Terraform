...
namespace aws.Waf
{
    ...
    public class WafWebAclRules : aws.Waf.IWafWebAclRules
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "action", typeJson: "{\"fqn\":\"aws.waf.WafWebAclRulesAction\"}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "overrideAction", typeJson: "{\"fqn\":\"aws.waf.WafWebAclRulesOverrideAction\"}", isOptional: true, isOverride: true)]
