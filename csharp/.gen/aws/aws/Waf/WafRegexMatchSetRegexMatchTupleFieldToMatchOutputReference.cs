...
namespace aws.Waf
{
    ...
    public class WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
