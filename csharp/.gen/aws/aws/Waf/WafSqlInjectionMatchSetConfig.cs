...
namespace aws.Waf
{
    ...
    public class WafSqlInjectionMatchSetConfig : aws.Waf.IWafSqlInjectionMatchSetConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "sqlInjectionMatchTuples", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.waf.WafSqlInjectionMatchSetSqlInjectionMatchTuples\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
