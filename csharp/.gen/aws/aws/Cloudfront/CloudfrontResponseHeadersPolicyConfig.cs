...
namespace aws.Cloudfront
{
    ...
    [JsiiByValue(fqn: "aws.cloudfront.CloudfrontResponseHeadersPolicyConfig")]
    public class CloudfrontResponseHeadersPolicyConfig : aws.Cloudfront.ICloudfrontResponseHeadersPolicyConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "corsConfig", typeJson: "{\"fqn\":\"aws.cloudfront.CloudfrontResponseHeadersPolicyCorsConfig\"}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "customHeadersConfig", typeJson: "{\"fqn\":\"aws.cloudfront.CloudfrontResponseHeadersPolicyCustomHeadersConfig\"}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "securityHeadersConfig", typeJson: "{\"fqn\":\"aws.cloudfront.CloudfrontResponseHeadersPolicySecurityHeadersConfig\"}", isOptional: true, isOverride: true)]
