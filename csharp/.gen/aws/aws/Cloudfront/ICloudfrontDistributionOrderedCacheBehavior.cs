...
namespace aws.Cloudfront
{
    ...
    public interface ICloudfrontDistributionOrderedCacheBehavior
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "forwardedValues", typeJson: "{\"fqn\":\"aws.cloudfront.CloudfrontDistributionOrderedCacheBehaviorForwardedValues\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        ...
        /// </remarks>
        [JsiiProperty(name: "functionAssociation", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.cloudfront.CloudfrontDistributionOrderedCacheBehaviorFunctionAssociation\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Cloudfront.ICloudfrontDistributionOrderedCacheBehaviorFunctionAssociation[]? FunctionAssociation
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "lambdaFunctionAssociation", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.cloudfront.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Cloudfront.ICloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation[]? LambdaFunctionAssociation
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, aws.Cloudfront.ICloudfrontDistributionOrderedCacheBehavior
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "functionAssociation", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.cloudfront.CloudfrontDistributionOrderedCacheBehaviorFunctionAssociation\"},\"kind\":\"array\"}}", isOptional: true)]
            public aws.Cloudfront.ICloudfrontDistributionOrderedCacheBehaviorFunctionAssociation[]? FunctionAssociation
            {
                get => GetInstanceProperty<aws.Cloudfront.ICloudfrontDistributionOrderedCacheBehaviorFunctionAssociation[]?>();
            }
            ...
            [JsiiOptional]
            [JsiiProperty(name: "lambdaFunctionAssociation", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.cloudfront.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation\"},\"kind\":\"array\"}}", isOptional: true)]
            public aws.Cloudfront.ICloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation[]? LambdaFunctionAssociation
            {
                get => GetInstanceProperty<aws.Cloudfront.ICloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation[]?>();
            }
