...
{
    [JsiiInterface(nativeType: typeof(ICloudfrontDistributionCustomErrorResponse), fullyQualifiedName: "aws.cloudfront.CloudfrontDistributionCustomErrorResponse")]
    public interface ICloudfrontDistributionCustomErrorResponse
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICloudfrontDistributionCustomErrorResponse), fullyQualifiedName: "aws.cloudfront.CloudfrontDistributionCustomErrorResponse")]
        internal sealed class _Proxy : DeputyBase, aws.Cloudfront.ICloudfrontDistributionCustomErrorResponse
        {
