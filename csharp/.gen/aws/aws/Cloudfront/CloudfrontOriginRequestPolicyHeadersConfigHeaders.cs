...
{
    [JsiiByValue(fqn: "aws.cloudfront.CloudfrontOriginRequestPolicyHeadersConfigHeaders")]
    public class CloudfrontOriginRequestPolicyHeadersConfigHeaders : aws.Cloudfront.ICloudfrontOriginRequestPolicyHeadersConfigHeaders
    {
