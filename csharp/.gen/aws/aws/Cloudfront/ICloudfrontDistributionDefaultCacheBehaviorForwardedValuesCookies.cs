...
{
    [JsiiInterface(nativeType: typeof(ICloudfrontDistributionDefaultCacheBehaviorForwardedValuesCookies), fullyQualifiedName: "aws.cloudfront.CloudfrontDistributionDefaultCacheBehaviorForwardedValuesCookies")]
    public interface ICloudfrontDistributionDefaultCacheBehaviorForwardedValuesCookies
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICloudfrontDistributionDefaultCacheBehaviorForwardedValuesCookies), fullyQualifiedName: "aws.cloudfront.CloudfrontDistributionDefaultCacheBehaviorForwardedValuesCookies")]
        internal sealed class _Proxy : DeputyBase, aws.Cloudfront.ICloudfrontDistributionDefaultCacheBehaviorForwardedValuesCookies
        {
