...
namespace aws.Appsync
{
    ...
    public class AppsyncGraphqlApiAdditionalAuthenticationProviderOpenidConnectConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public AppsyncGraphqlApiAdditionalAuthenticationProviderOpenidConnectConfigOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
