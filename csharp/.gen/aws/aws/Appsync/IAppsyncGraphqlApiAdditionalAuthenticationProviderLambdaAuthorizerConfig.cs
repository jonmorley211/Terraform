...
{
    [JsiiInterface(nativeType: typeof(IAppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig), fullyQualifiedName: "aws.appsync.AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig")]
    public interface IAppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig), fullyQualifiedName: "aws.appsync.AppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Appsync.IAppsyncGraphqlApiAdditionalAuthenticationProviderLambdaAuthorizerConfig
        {
