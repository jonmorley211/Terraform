...
namespace aws.Appsync
{
    ...
    [JsiiByValue(fqn: "aws.appsync.AppsyncGraphqlApiLambdaAuthorizerConfig")]
    public class AppsyncGraphqlApiLambdaAuthorizerConfig : aws.Appsync.IAppsyncGraphqlApiLambdaAuthorizerConfig
    {
