...
namespace aws.Neptune
{
    ...
    [JsiiInterface(nativeType: typeof(INeptuneClusterEndpointConfig), fullyQualifiedName: "aws.neptune.NeptuneClusterEndpointConfig")]
    public interface INeptuneClusterEndpointConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Neptune.</summary>
        [JsiiTypeProxy(nativeType: typeof(INeptuneClusterEndpointConfig), fullyQualifiedName: "aws.neptune.NeptuneClusterEndpointConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Neptune.INeptuneClusterEndpointConfig
        {
