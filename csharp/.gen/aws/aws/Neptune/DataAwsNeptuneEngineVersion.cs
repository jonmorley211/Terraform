...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/d/neptune_engine_version aws_neptune_engine_version}.</summary>
    [JsiiClass(nativeType: typeof(aws.Neptune.DataAwsNeptuneEngineVersion), fullyQualifiedName: "aws.neptune.DataAwsNeptuneEngineVersion", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.neptune.DataAwsNeptuneEngineVersionConfig\"}}]")]
    public class DataAwsNeptuneEngineVersion : HashiCorp.Cdktf.TerraformDataSource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/d/neptune_engine_version aws_neptune_engine_version} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataAwsNeptuneEngineVersion(Constructs.Construct scope, string id, aws.Neptune.IDataAwsNeptuneEngineVersionConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Neptune.DataAwsNeptuneEngineVersion))!;
