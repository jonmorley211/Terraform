...
namespace aws.Cognito
{
    ...
    [JsiiByValue(fqn: "aws.cognito.DataAwsCognitoUserPoolSigningCertificateConfig")]
    public class DataAwsCognitoUserPoolSigningCertificateConfig : aws.Cognito.IDataAwsCognitoUserPoolSigningCertificateConfig
    {
