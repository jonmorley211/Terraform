...
namespace aws.Cognito
{
    ...
    [JsiiByValue(fqn: "aws.cognito.CognitoUserPoolLambdaConfigCustomSmsSender")]
    public class CognitoUserPoolLambdaConfigCustomSmsSender : aws.Cognito.ICognitoUserPoolLambdaConfigCustomSmsSender
    {
