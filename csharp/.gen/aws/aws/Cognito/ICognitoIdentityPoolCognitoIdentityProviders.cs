...
{
    [JsiiInterface(nativeType: typeof(ICognitoIdentityPoolCognitoIdentityProviders), fullyQualifiedName: "aws.cognito.CognitoIdentityPoolCognitoIdentityProviders")]
    public interface ICognitoIdentityPoolCognitoIdentityProviders
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICognitoIdentityPoolCognitoIdentityProviders), fullyQualifiedName: "aws.cognito.CognitoIdentityPoolCognitoIdentityProviders")]
        internal sealed class _Proxy : DeputyBase, aws.Cognito.ICognitoIdentityPoolCognitoIdentityProviders
        {
