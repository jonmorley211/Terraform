...
namespace aws.Cognito
{
    ...
    public class CognitoUserPoolSmsConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CognitoUserPoolSmsConfigurationOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
