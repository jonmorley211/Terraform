...
namespace aws.Cognito
{
    ...
    public interface ICognitoUserPoolLambdaConfig
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "customEmailSender", typeJson: "{\"fqn\":\"aws.cognito.CognitoUserPoolLambdaConfigCustomEmailSender\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Cognito.ICognitoUserPoolLambdaConfigCustomEmailSender? CustomEmailSender
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "customSmsSender", typeJson: "{\"fqn\":\"aws.cognito.CognitoUserPoolLambdaConfigCustomSmsSender\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Cognito.ICognitoUserPoolLambdaConfigCustomSmsSender? CustomSmsSender
        {
            get
            {
                return null;
