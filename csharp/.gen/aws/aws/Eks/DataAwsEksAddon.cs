...
namespace aws.Eks
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/d/eks_addon aws_eks_addon}.</summary>
    [JsiiClass(nativeType: typeof(aws.Eks.DataAwsEksAddon), fullyQualifiedName: "aws.eks.DataAwsEksAddon", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.eks.DataAwsEksAddonConfig\"}}]")]
    public class DataAwsEksAddon : HashiCorp.Cdktf.TerraformDataSource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/d/eks_addon aws_eks_addon} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataAwsEksAddon(Constructs.Construct scope, string id, aws.Eks.IDataAwsEksAddonConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Eks.DataAwsEksAddon))!;
