...
namespace aws.Eks
{
    [JsiiInterface(nativeType: typeof(IEksNodeGroupTimeouts), fullyQualifiedName: "aws.eks.EksNodeGroupTimeouts")]
    public interface IEksNodeGroupTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEksNodeGroupTimeouts), fullyQualifiedName: "aws.eks.EksNodeGroupTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Eks.IEksNodeGroupTimeouts
        {
