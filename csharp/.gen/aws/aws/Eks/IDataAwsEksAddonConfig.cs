...
namespace aws.Eks
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsEksAddonConfig), fullyQualifiedName: "aws.eks.DataAwsEksAddonConfig")]
    public interface IDataAwsEksAddonConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Elastic Kubernetes Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsEksAddonConfig), fullyQualifiedName: "aws.eks.DataAwsEksAddonConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Eks.IDataAwsEksAddonConfig
        {
