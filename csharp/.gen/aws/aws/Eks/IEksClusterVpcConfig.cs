...
namespace aws.Eks
{
    [JsiiInterface(nativeType: typeof(IEksClusterVpcConfig), fullyQualifiedName: "aws.eks.EksClusterVpcConfig")]
    public interface IEksClusterVpcConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEksClusterVpcConfig), fullyQualifiedName: "aws.eks.EksClusterVpcConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Eks.IEksClusterVpcConfig
        {
