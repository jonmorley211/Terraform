...
namespace aws.Eks
{
    [JsiiInterface(nativeType: typeof(IEksIdentityProviderConfigOidc), fullyQualifiedName: "aws.eks.EksIdentityProviderConfigOidc")]
    public interface IEksIdentityProviderConfigOidc
    {
        ...
        [JsiiProperty(name: "requiredClaims", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"map\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        ...
        [JsiiTypeProxy(nativeType: typeof(IEksIdentityProviderConfigOidc), fullyQualifiedName: "aws.eks.EksIdentityProviderConfigOidc")]
        internal sealed class _Proxy : DeputyBase, aws.Eks.IEksIdentityProviderConfigOidc
        {
