...
namespace aws.Eks
{
    [JsiiInterface(nativeType: typeof(IEksClusterTimeouts), fullyQualifiedName: "aws.eks.EksClusterTimeouts")]
    public interface IEksClusterTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEksClusterTimeouts), fullyQualifiedName: "aws.eks.EksClusterTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Eks.IEksClusterTimeouts
        {
