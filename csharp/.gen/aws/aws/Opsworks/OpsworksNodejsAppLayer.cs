...
namespace aws.Opsworks
{
    ...
    public class OpsworksNodejsAppLayer : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksNodejsAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Opsworks.IOpsworksNodejsAppLayerEbsVolume[]? EbsVolumeInput
        {
            get => GetInstanceProperty<aws.Opsworks.IOpsworksNodejsAppLayerEbsVolume[]?>();
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksNodejsAppLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.Opsworks.IOpsworksNodejsAppLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.Opsworks.IOpsworksNodejsAppLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
