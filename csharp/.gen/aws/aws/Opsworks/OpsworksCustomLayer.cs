...
namespace aws.Opsworks
{
    ...
    public class OpsworksCustomLayer : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksCustomLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Opsworks.IOpsworksCustomLayerEbsVolume[]? EbsVolumeInput
        {
            get => GetInstanceProperty<aws.Opsworks.IOpsworksCustomLayerEbsVolume[]?>();
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksCustomLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.Opsworks.IOpsworksCustomLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.Opsworks.IOpsworksCustomLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
