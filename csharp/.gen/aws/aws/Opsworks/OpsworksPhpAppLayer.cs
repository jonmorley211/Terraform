...
namespace aws.Opsworks
{
    ...
    public class OpsworksPhpAppLayer : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksPhpAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Opsworks.IOpsworksPhpAppLayerEbsVolume[]? EbsVolumeInput
        {
            get => GetInstanceProperty<aws.Opsworks.IOpsworksPhpAppLayerEbsVolume[]?>();
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksPhpAppLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.Opsworks.IOpsworksPhpAppLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.Opsworks.IOpsworksPhpAppLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
