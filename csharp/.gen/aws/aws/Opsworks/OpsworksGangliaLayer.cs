...
namespace aws.Opsworks
{
    ...
    public class OpsworksGangliaLayer : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksGangliaLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Opsworks.IOpsworksGangliaLayerEbsVolume[]? EbsVolumeInput
        {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksGangliaLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.Opsworks.IOpsworksGangliaLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.Opsworks.IOpsworksGangliaLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
