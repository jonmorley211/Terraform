...
namespace aws.Opsworks
{
    ...
    public class OpsworksRdsDbInstanceConfig : aws.Opsworks.IOpsworksRdsDbInstanceConfig
    {
        ...
        [JsiiProperty(name: "dbPassword", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiProperty(name: "dbUser", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiProperty(name: "rdsDbInstanceArn", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
