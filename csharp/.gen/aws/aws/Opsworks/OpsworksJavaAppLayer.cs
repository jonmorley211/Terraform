...
namespace aws.Opsworks
{
    ...
    public class OpsworksJavaAppLayer : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksJavaAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Opsworks.IOpsworksJavaAppLayerEbsVolume[]? EbsVolumeInput
        {
            get => GetInstanceProperty<aws.Opsworks.IOpsworksJavaAppLayerEbsVolume[]?>();
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksJavaAppLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.Opsworks.IOpsworksJavaAppLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.Opsworks.IOpsworksJavaAppLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
