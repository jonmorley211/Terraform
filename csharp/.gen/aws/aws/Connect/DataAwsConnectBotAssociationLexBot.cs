...
namespace aws.Connect
{
    ...
    [JsiiByValue(fqn: "aws.connect.DataAwsConnectBotAssociationLexBot")]
    public class DataAwsConnectBotAssociationLexBot : aws.Connect.IDataAwsConnectBotAssociationLexBot
    {
