...
namespace aws.Connect
{
    ...
    [JsiiByValue(fqn: "aws.connect.ConnectHoursOfOperationConfigStartTime")]
    public class ConnectHoursOfOperationConfigStartTime : aws.Connect.IConnectHoursOfOperationConfigStartTime
    {
