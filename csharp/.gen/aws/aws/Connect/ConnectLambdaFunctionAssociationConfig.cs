...
namespace aws.Connect
{
    ...
    [JsiiByValue(fqn: "aws.connect.ConnectLambdaFunctionAssociationConfig")]
    public class ConnectLambdaFunctionAssociationConfig : aws.Connect.IConnectLambdaFunctionAssociationConfig
    {
