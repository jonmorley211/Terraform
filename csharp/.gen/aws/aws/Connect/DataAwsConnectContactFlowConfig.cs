...
namespace aws.Connect
{
    ...
    [JsiiByValue(fqn: "aws.connect.DataAwsConnectContactFlowConfig")]
    public class DataAwsConnectContactFlowConfig : aws.Connect.IDataAwsConnectContactFlowConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "contactFlowId", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
