...
namespace aws.S3
{
    [JsiiInterface(nativeType: typeof(IS3BucketCorsRule), fullyQualifiedName: "aws.s3.S3BucketCorsRule")]
    public interface IS3BucketCorsRule
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IS3BucketCorsRule), fullyQualifiedName: "aws.s3.S3BucketCorsRule")]
        internal sealed class _Proxy : DeputyBase, aws.S3.IS3BucketCorsRule
        {
