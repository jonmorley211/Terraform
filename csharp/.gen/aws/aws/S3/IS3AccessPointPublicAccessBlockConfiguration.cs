...
namespace aws.S3
{
    [JsiiInterface(nativeType: typeof(IS3AccessPointPublicAccessBlockConfiguration), fullyQualifiedName: "aws.s3.S3AccessPointPublicAccessBlockConfiguration")]
    public interface IS3AccessPointPublicAccessBlockConfiguration
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IS3AccessPointPublicAccessBlockConfiguration), fullyQualifiedName: "aws.s3.S3AccessPointPublicAccessBlockConfiguration")]
        internal sealed class _Proxy : DeputyBase, aws.S3.IS3AccessPointPublicAccessBlockConfiguration
        {
