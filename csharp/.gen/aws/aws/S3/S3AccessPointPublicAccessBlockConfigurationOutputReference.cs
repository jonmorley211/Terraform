...
namespace aws.S3
{
    [JsiiClass(nativeType: typeof(aws.S3.S3AccessPointPublicAccessBlockConfigurationOutputReference), fullyQualifiedName: "aws.s3.S3AccessPointPublicAccessBlockConfigurationOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.ITerraformResource\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"True if this is a block, false if it's a list.\"},\"name\":\"isSingleItem\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class S3AccessPointPublicAccessBlockConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public S3AccessPointPublicAccessBlockConfigurationOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
