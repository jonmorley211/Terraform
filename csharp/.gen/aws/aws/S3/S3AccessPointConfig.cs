...
namespace aws.S3
{
    ...
    public class S3AccessPointConfig : aws.S3.IS3AccessPointConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "publicAccessBlockConfiguration", typeJson: "{\"fqn\":\"aws.s3.S3AccessPointPublicAccessBlockConfiguration\"}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "vpcConfiguration", typeJson: "{\"fqn\":\"aws.s3.S3AccessPointVpcConfiguration\"}", isOptional: true, isOverride: true)]
