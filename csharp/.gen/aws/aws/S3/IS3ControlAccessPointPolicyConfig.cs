...
namespace aws.S3
{
    ...
    [JsiiInterface(nativeType: typeof(IS3ControlAccessPointPolicyConfig), fullyQualifiedName: "aws.s3.S3ControlAccessPointPolicyConfig")]
    public interface IS3ControlAccessPointPolicyConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Simple Storage Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IS3ControlAccessPointPolicyConfig), fullyQualifiedName: "aws.s3.S3ControlAccessPointPolicyConfig")]
        internal sealed class _Proxy : DeputyBase, aws.S3.IS3ControlAccessPointPolicyConfig
        {
