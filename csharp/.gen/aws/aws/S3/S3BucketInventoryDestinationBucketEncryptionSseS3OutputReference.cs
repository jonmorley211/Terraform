...
namespace aws.S3
{
    ...
    public class S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
