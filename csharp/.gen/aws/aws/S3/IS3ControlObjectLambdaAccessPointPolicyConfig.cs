...
namespace aws.S3
{
    ...
    [JsiiInterface(nativeType: typeof(IS3ControlObjectLambdaAccessPointPolicyConfig), fullyQualifiedName: "aws.s3.S3ControlObjectLambdaAccessPointPolicyConfig")]
    public interface IS3ControlObjectLambdaAccessPointPolicyConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Simple Storage Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IS3ControlObjectLambdaAccessPointPolicyConfig), fullyQualifiedName: "aws.s3.S3ControlObjectLambdaAccessPointPolicyConfig")]
        internal sealed class _Proxy : DeputyBase, aws.S3.IS3ControlObjectLambdaAccessPointPolicyConfig
        {
