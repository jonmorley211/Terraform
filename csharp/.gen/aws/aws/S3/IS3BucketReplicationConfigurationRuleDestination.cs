...
namespace aws.S3
{
    [JsiiInterface(nativeType: typeof(IS3BucketReplicationConfigurationRuleDestination), fullyQualifiedName: "aws.s3.S3BucketReplicationConfigurationRuleDestination")]
    public interface IS3BucketReplicationConfigurationRuleDestination
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "accessControlTranslation", typeJson: "{\"fqn\":\"aws.s3.S3BucketReplicationConfigurationRuleDestinationAccessControlTranslation\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.S3.IS3BucketReplicationConfigurationRuleDestinationAccessControlTranslation? AccessControlTranslation
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "encryptionConfiguration", typeJson: "{\"fqn\":\"aws.s3.S3BucketReplicationConfigurationRuleDestinationEncryptionConfiguration\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.S3.IS3BucketReplicationConfigurationRuleDestinationEncryptionConfiguration? EncryptionConfiguration
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "metrics", typeJson: "{\"fqn\":\"aws.s3.S3BucketReplicationConfigurationRuleDestinationMetrics\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.S3.IS3BucketReplicationConfigurationRuleDestinationMetrics? Metrics
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "replicationTime", typeJson: "{\"fqn\":\"aws.s3.S3BucketReplicationConfigurationRuleDestinationReplicationTime\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.S3.IS3BucketReplicationConfigurationRuleDestinationReplicationTime? ReplicationTime
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IS3BucketReplicationConfigurationRuleDestination), fullyQualifiedName: "aws.s3.S3BucketReplicationConfigurationRuleDestination")]
        internal sealed class _Proxy : DeputyBase, aws.S3.IS3BucketReplicationConfigurationRuleDestination
        {
