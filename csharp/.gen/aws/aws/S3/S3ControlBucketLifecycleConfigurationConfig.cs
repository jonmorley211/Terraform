...
namespace aws.S3
{
    ...
    [JsiiByValue(fqn: "aws.s3.S3ControlBucketLifecycleConfigurationConfig")]
    public class S3ControlBucketLifecycleConfigurationConfig : aws.S3.IS3ControlBucketLifecycleConfigurationConfig
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "rule", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.s3.S3ControlBucketLifecycleConfigurationRule\"},\"kind\":\"array\"}}", isOverride: true)]
