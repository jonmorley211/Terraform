...
namespace aws.S3
{
    [JsiiByValue(fqn: "aws.s3.S3BucketReplicationConfigurationRuleFilterAnd")]
    public class S3BucketReplicationConfigurationRuleFilterAnd : aws.S3.IS3BucketReplicationConfigurationRuleFilterAnd
    {
