...
namespace aws.S3
{
    [JsiiInterface(nativeType: typeof(IS3BucketInventoryDestinationBucket), fullyQualifiedName: "aws.s3.S3BucketInventoryDestinationBucket")]
    public interface IS3BucketInventoryDestinationBucket
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.S3.IS3BucketInventoryDestinationBucketEncryption? Encryption
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IS3BucketInventoryDestinationBucket), fullyQualifiedName: "aws.s3.S3BucketInventoryDestinationBucket")]
        internal sealed class _Proxy : DeputyBase, aws.S3.IS3BucketInventoryDestinationBucket
        {
