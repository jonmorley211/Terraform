...
namespace aws.S3
{
    ...
    public interface IS3BucketReplicationConfigurationRulesDestination
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "metrics", typeJson: "{\"fqn\":\"aws.s3.S3BucketReplicationConfigurationRulesDestinationMetrics\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.S3.IS3BucketReplicationConfigurationRulesDestinationMetrics? Metrics
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "replicationTime", typeJson: "{\"fqn\":\"aws.s3.S3BucketReplicationConfigurationRulesDestinationReplicationTime\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.S3.IS3BucketReplicationConfigurationRulesDestinationReplicationTime? ReplicationTime
        {
            get
            {
                return null;
