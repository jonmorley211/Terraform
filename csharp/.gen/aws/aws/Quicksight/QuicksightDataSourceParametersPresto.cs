...
namespace aws.Quicksight
{
    ...
    [JsiiByValue(fqn: "aws.quicksight.QuicksightDataSourceParametersPresto")]
    public class QuicksightDataSourceParametersPresto : aws.Quicksight.IQuicksightDataSourceParametersPresto
    {
        ...
        [JsiiProperty(name: "catalog", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
