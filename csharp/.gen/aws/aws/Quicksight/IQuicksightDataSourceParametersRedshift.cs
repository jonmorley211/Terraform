...
{
    [JsiiInterface(nativeType: typeof(IQuicksightDataSourceParametersRedshift), fullyQualifiedName: "aws.quicksight.QuicksightDataSourceParametersRedshift")]
    public interface IQuicksightDataSourceParametersRedshift
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuicksightDataSourceParametersRedshift), fullyQualifiedName: "aws.quicksight.QuicksightDataSourceParametersRedshift")]
        internal sealed class _Proxy : DeputyBase, aws.Quicksight.IQuicksightDataSourceParametersRedshift
        {
