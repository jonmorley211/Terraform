...
namespace aws.Quicksight
{
    ...
    [JsiiByValue(fqn: "aws.quicksight.QuicksightDataSourceParametersAurora")]
    public class QuicksightDataSourceParametersAurora : aws.Quicksight.IQuicksightDataSourceParametersAurora
    {
