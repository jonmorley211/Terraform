...
{
    [JsiiInterface(nativeType: typeof(IQuicksightDataSourceParametersPostgresql), fullyQualifiedName: "aws.quicksight.QuicksightDataSourceParametersPostgresql")]
    public interface IQuicksightDataSourceParametersPostgresql
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuicksightDataSourceParametersPostgresql), fullyQualifiedName: "aws.quicksight.QuicksightDataSourceParametersPostgresql")]
        internal sealed class _Proxy : DeputyBase, aws.Quicksight.IQuicksightDataSourceParametersPostgresql
        {
