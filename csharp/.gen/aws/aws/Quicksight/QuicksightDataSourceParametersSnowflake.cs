...
namespace aws.Quicksight
{
    ...
    [JsiiByValue(fqn: "aws.quicksight.QuicksightDataSourceParametersSnowflake")]
    public class QuicksightDataSourceParametersSnowflake : aws.Quicksight.IQuicksightDataSourceParametersSnowflake
    {
        ...
        [JsiiProperty(name: "warehouse", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
