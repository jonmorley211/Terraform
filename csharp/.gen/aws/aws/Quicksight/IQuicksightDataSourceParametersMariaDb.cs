...
{
    [JsiiInterface(nativeType: typeof(IQuicksightDataSourceParametersMariaDb), fullyQualifiedName: "aws.quicksight.QuicksightDataSourceParametersMariaDb")]
    public interface IQuicksightDataSourceParametersMariaDb
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuicksightDataSourceParametersMariaDb), fullyQualifiedName: "aws.quicksight.QuicksightDataSourceParametersMariaDb")]
        internal sealed class _Proxy : DeputyBase, aws.Quicksight.IQuicksightDataSourceParametersMariaDb
        {
