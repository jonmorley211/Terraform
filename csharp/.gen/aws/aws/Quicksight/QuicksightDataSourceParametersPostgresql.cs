...
namespace aws.Quicksight
{
    ...
    [JsiiByValue(fqn: "aws.quicksight.QuicksightDataSourceParametersPostgresql")]
    public class QuicksightDataSourceParametersPostgresql : aws.Quicksight.IQuicksightDataSourceParametersPostgresql
    {
