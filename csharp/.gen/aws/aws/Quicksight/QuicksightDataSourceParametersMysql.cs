...
namespace aws.Quicksight
{
    ...
    [JsiiByValue(fqn: "aws.quicksight.QuicksightDataSourceParametersMysql")]
    public class QuicksightDataSourceParametersMysql : aws.Quicksight.IQuicksightDataSourceParametersMysql
    {
