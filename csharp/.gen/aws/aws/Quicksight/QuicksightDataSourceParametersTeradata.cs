...
namespace aws.Quicksight
{
    ...
    [JsiiByValue(fqn: "aws.quicksight.QuicksightDataSourceParametersTeradata")]
    public class QuicksightDataSourceParametersTeradata : aws.Quicksight.IQuicksightDataSourceParametersTeradata
    {
