...
namespace aws.Quicksight
{
    ...
    [JsiiByValue(fqn: "aws.quicksight.QuicksightDataSourceParametersServiceNow")]
    public class QuicksightDataSourceParametersServiceNow : aws.Quicksight.IQuicksightDataSourceParametersServiceNow
    {
