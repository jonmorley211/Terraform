...
namespace aws.Quicksight
{
    ...
    [JsiiByValue(fqn: "aws.quicksight.QuicksightDataSourceParametersMariaDb")]
    public class QuicksightDataSourceParametersMariaDb : aws.Quicksight.IQuicksightDataSourceParametersMariaDb
    {
