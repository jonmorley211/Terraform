...
{
    [JsiiInterface(nativeType: typeof(IQuicksightDataSourceParametersTeradata), fullyQualifiedName: "aws.quicksight.QuicksightDataSourceParametersTeradata")]
    public interface IQuicksightDataSourceParametersTeradata
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuicksightDataSourceParametersTeradata), fullyQualifiedName: "aws.quicksight.QuicksightDataSourceParametersTeradata")]
        internal sealed class _Proxy : DeputyBase, aws.Quicksight.IQuicksightDataSourceParametersTeradata
        {
