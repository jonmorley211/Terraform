...
namespace aws.Quicksight
{
    ...
    [JsiiByValue(fqn: "aws.quicksight.QuicksightDataSourceParametersSqlServer")]
    public class QuicksightDataSourceParametersSqlServer : aws.Quicksight.IQuicksightDataSourceParametersSqlServer
    {
