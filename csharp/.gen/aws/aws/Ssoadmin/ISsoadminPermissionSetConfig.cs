...
namespace aws.Ssoadmin
{
    ...
    [JsiiInterface(nativeType: typeof(ISsoadminPermissionSetConfig), fullyQualifiedName: "aws.ssoadmin.SsoadminPermissionSetConfig")]
    public interface ISsoadminPermissionSetConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS SSO Admin.</summary>
        [JsiiTypeProxy(nativeType: typeof(ISsoadminPermissionSetConfig), fullyQualifiedName: "aws.ssoadmin.SsoadminPermissionSetConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Ssoadmin.ISsoadminPermissionSetConfig
        {
