...
namespace aws.Elasticsearch
{
    ...
    [JsiiByValue(fqn: "aws.elasticsearch.ElasticsearchDomainSamlOptionsConfig")]
    public class ElasticsearchDomainSamlOptionsConfig : aws.Elasticsearch.IElasticsearchDomainSamlOptionsConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "samlOptions", typeJson: "{\"fqn\":\"aws.elasticsearch.ElasticsearchDomainSamlOptionsSamlOptions\"}", isOptional: true, isOverride: true)]
