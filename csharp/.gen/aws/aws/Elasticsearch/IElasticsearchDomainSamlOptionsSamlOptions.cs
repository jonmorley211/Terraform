...
{
    [JsiiInterface(nativeType: typeof(IElasticsearchDomainSamlOptionsSamlOptions), fullyQualifiedName: "aws.elasticsearch.ElasticsearchDomainSamlOptionsSamlOptions")]
    public interface IElasticsearchDomainSamlOptionsSamlOptions
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "idp", typeJson: "{\"fqn\":\"aws.elasticsearch.ElasticsearchDomainSamlOptionsSamlOptionsIdp\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Elasticsearch.IElasticsearchDomainSamlOptionsSamlOptionsIdp? Idp
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IElasticsearchDomainSamlOptionsSamlOptions), fullyQualifiedName: "aws.elasticsearch.ElasticsearchDomainSamlOptionsSamlOptions")]
        internal sealed class _Proxy : DeputyBase, aws.Elasticsearch.IElasticsearchDomainSamlOptionsSamlOptions
        {
