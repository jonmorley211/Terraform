...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/networkfirewall_firewall aws_networkfirewall_firewall}.</summary>
    [JsiiClass(nativeType: typeof(aws.Networkfirewall.NetworkfirewallFirewall), fullyQualifiedName: "aws.networkfirewall.NetworkfirewallFirewall", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.networkfirewall.NetworkfirewallFirewallConfig\"}}]")]
    public class NetworkfirewallFirewall : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/networkfirewall_firewall aws_networkfirewall_firewall} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public NetworkfirewallFirewall(Constructs.Construct scope, string id, aws.Networkfirewall.INetworkfirewallFirewallConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiMethod(name: "firewallStatus", returnsJson: "{\"type\":{\"fqn\":\"aws.networkfirewall.NetworkfirewallFirewallFirewallStatus\"}}", parametersJson: "[{\"name\":\"index\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual aws.Networkfirewall.NetworkfirewallFirewallFirewallStatus FirewallStatus(string index)
        {
            return InvokeInstanceMethod<aws.Networkfirewall.NetworkfirewallFirewallFirewallStatus>(new System.Type[]{typeof(string)}, new object[]{index})!;
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Networkfirewall.NetworkfirewallFirewall))!;
        ...
        [JsiiOptional]
        [JsiiProperty(name: "subnetMappingInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.networkfirewall.NetworkfirewallFirewallSubnetMapping\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Networkfirewall.INetworkfirewallFirewallSubnetMapping[]? SubnetMappingInput
        {
        ...
        public virtual aws.Networkfirewall.INetworkfirewallFirewallSubnetMapping[] SubnetMapping
        {
            get => GetInstanceProperty<aws.Networkfirewall.INetworkfirewallFirewallSubnetMapping[]>()!;
            set => SetInstanceProperty(value);
        }
