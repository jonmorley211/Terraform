...
namespace aws.Timestreamwrite
{
    ...
    [JsiiInterface(nativeType: typeof(ITimestreamwriteDatabaseConfig), fullyQualifiedName: "aws.timestreamwrite.TimestreamwriteDatabaseConfig")]
    public interface ITimestreamwriteDatabaseConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Timestream Write.</summary>
        [JsiiTypeProxy(nativeType: typeof(ITimestreamwriteDatabaseConfig), fullyQualifiedName: "aws.timestreamwrite.TimestreamwriteDatabaseConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Timestreamwrite.ITimestreamwriteDatabaseConfig
        {
