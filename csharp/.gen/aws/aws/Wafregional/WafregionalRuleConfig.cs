...
namespace aws.Wafregional
{
    ...
    public class WafregionalRuleConfig : aws.Wafregional.IWafregionalRuleConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "predicate", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.wafregional.WafregionalRulePredicate\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        public aws.Wafregional.IWafregionalRulePredicate[]? Predicate
        {
            get;
            set;
        }
        ...
        /// <summary>Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/wafregional_rule#tags_all WafregionalRule#tags_all}.</summary>
        [JsiiOptional]
