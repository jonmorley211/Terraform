...
namespace aws.Wafregional
{
    ...
    public class WafregionalRateBasedRuleConfig : aws.Wafregional.IWafregionalRateBasedRuleConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "predicate", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.wafregional.WafregionalRateBasedRulePredicate\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        public aws.Wafregional.IWafregionalRateBasedRulePredicate[]? Predicate
        {
            get;
            set;
        }
        ...
        /// <summary>Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/wafregional_rate_based_rule#tags_all WafregionalRateBasedRule#tags_all}.</summary>
        [JsiiOptional]
