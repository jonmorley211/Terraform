...
namespace aws.Ec2
{
    ...
    public interface ISpotFleetRequestLaunchSpecification
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "ebsBlockDevice", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ec2.SpotFleetRequestLaunchSpecificationEbsBlockDevice\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Ec2.ISpotFleetRequestLaunchSpecificationEbsBlockDevice[]? EbsBlockDevice
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "ephemeralBlockDevice", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ec2.SpotFleetRequestLaunchSpecificationEphemeralBlockDevice\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Ec2.ISpotFleetRequestLaunchSpecificationEphemeralBlockDevice[]? EphemeralBlockDevice
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "rootBlockDevice", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ec2.SpotFleetRequestLaunchSpecificationRootBlockDevice\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Ec2.ISpotFleetRequestLaunchSpecificationRootBlockDevice[]? RootBlockDevice
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, aws.Ec2.ISpotFleetRequestLaunchSpecification
        {
            ...
            {
                get => GetInstanceProperty<aws.Ec2.ISpotFleetRequestLaunchSpecificationEbsBlockDevice[]?>();
            }
            ...
            {
                get => GetInstanceProperty<aws.Ec2.ISpotFleetRequestLaunchSpecificationEphemeralBlockDevice[]?>();
            }
            ...
            {
                get => GetInstanceProperty<aws.Ec2.ISpotFleetRequestLaunchSpecificationRootBlockDevice[]?>();
            }
