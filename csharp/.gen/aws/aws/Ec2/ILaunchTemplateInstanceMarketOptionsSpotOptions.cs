...
namespace aws.Ec2
{
    [JsiiInterface(nativeType: typeof(ILaunchTemplateInstanceMarketOptionsSpotOptions), fullyQualifiedName: "aws.ec2.LaunchTemplateInstanceMarketOptionsSpotOptions")]
    public interface ILaunchTemplateInstanceMarketOptionsSpotOptions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILaunchTemplateInstanceMarketOptionsSpotOptions), fullyQualifiedName: "aws.ec2.LaunchTemplateInstanceMarketOptionsSpotOptions")]
        internal sealed class _Proxy : DeputyBase, aws.Ec2.ILaunchTemplateInstanceMarketOptionsSpotOptions
        {
