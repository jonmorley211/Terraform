...
namespace aws.Ec2
{
    ...
    public class Ec2FleetLaunchTemplateConfigLaunchTemplateSpecificationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public Ec2FleetLaunchTemplateConfigLaunchTemplateSpecificationOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
