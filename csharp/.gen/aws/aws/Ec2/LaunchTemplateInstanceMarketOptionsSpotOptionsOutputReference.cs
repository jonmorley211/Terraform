...
namespace aws.Ec2
{
    ...
    public class LaunchTemplateInstanceMarketOptionsSpotOptionsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LaunchTemplateInstanceMarketOptionsSpotOptionsOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
