...
namespace aws.Ec2
{
    ...
    public class DataAwsEc2LocalGatewayRouteTable : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "filterInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ec2.DataAwsEc2LocalGatewayRouteTableFilter\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Ec2.IDataAwsEc2LocalGatewayRouteTableFilter[]? FilterInput
        {
            get => GetInstanceProperty<aws.Ec2.IDataAwsEc2LocalGatewayRouteTableFilter[]?>();
        }
        ...
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ec2.DataAwsEc2LocalGatewayRouteTableFilter\"},\"kind\":\"array\"}}")]
        public virtual aws.Ec2.IDataAwsEc2LocalGatewayRouteTableFilter[] Filter
        {
            get => GetInstanceProperty<aws.Ec2.IDataAwsEc2LocalGatewayRouteTableFilter[]>()!;
