...
namespace aws.Ec2
{
    [JsiiClass(nativeType: typeof(aws.Ec2.DataAwsInstanceEbsBlockDevice), fullyQualifiedName: "aws.ec2.DataAwsInstanceEbsBlockDevice", parametersJson: "[{\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.ITerraformResource\"}},{\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"complexComputedListIndex\",\"type\":{\"primitive\":\"string\"}}]")]
    public class DataAwsInstanceEbsBlockDevice : HashiCorp.Cdktf.ComplexComputedList
    {
        /// <remarks>
        /// <strong>Stability</strong>: Experimental
        /// </remarks>
        public DataAwsInstanceEbsBlockDevice(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, string complexComputedListIndex): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, complexComputedListIndex}))
        {
        }
        ...
        protected DataAwsInstanceEbsBlockDevice(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataAwsInstanceEbsBlockDevice(DeputyProps props): base(props)
        {
        }
