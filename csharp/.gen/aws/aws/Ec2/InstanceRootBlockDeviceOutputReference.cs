...
namespace aws.Ec2
{
    ...
    public class InstanceRootBlockDeviceOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public InstanceRootBlockDeviceOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
