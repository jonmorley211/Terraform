...
namespace aws.Ec2
{
    [JsiiInterface(nativeType: typeof(ISpotFleetRequestLaunchTemplateConfigOverrides), fullyQualifiedName: "aws.ec2.SpotFleetRequestLaunchTemplateConfigOverrides")]
    public interface ISpotFleetRequestLaunchTemplateConfigOverrides
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISpotFleetRequestLaunchTemplateConfigOverrides), fullyQualifiedName: "aws.ec2.SpotFleetRequestLaunchTemplateConfigOverrides")]
        internal sealed class _Proxy : DeputyBase, aws.Ec2.ISpotFleetRequestLaunchTemplateConfigOverrides
        {
