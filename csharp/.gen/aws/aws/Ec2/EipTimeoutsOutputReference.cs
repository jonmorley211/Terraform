...
namespace aws.Ec2
{
    ...
    public class EipTimeoutsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public EipTimeoutsOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
