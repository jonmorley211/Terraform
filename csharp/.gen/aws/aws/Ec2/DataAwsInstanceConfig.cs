...
namespace aws.Ec2
{
    ...
    public class DataAwsInstanceConfig : aws.Ec2.IDataAwsInstanceConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "fetchUserData", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ec2.DataAwsInstanceFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
