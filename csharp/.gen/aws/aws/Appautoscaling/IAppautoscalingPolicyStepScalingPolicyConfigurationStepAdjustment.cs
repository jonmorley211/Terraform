...
{
    [JsiiInterface(nativeType: typeof(IAppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment), fullyQualifiedName: "aws.appautoscaling.AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment")]
    public interface IAppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment), fullyQualifiedName: "aws.appautoscaling.AppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment")]
        internal sealed class _Proxy : DeputyBase, aws.Appautoscaling.IAppautoscalingPolicyStepScalingPolicyConfigurationStepAdjustment
        {
