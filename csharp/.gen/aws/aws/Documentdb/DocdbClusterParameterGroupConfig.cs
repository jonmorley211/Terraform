...
namespace aws.Documentdb
{
    ...
    public class DocdbClusterParameterGroupConfig : aws.Documentdb.IDocdbClusterParameterGroupConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "parameter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.documentdb.DocdbClusterParameterGroupParameter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
