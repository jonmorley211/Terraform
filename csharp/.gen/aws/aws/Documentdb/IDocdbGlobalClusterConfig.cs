...
namespace aws.Documentdb
{
    ...
    [JsiiInterface(nativeType: typeof(IDocdbGlobalClusterConfig), fullyQualifiedName: "aws.documentdb.DocdbGlobalClusterConfig")]
    public interface IDocdbGlobalClusterConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.documentdb.DocdbGlobalClusterTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Documentdb.IDocdbGlobalClusterTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        /// <summary>AWS DocumentDB.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDocdbGlobalClusterConfig), fullyQualifiedName: "aws.documentdb.DocdbGlobalClusterConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Documentdb.IDocdbGlobalClusterConfig
        {
