...
namespace aws.Documentdb
{
    ...
    [JsiiByValue(fqn: "aws.documentdb.DataAwsDocdbEngineVersionConfig")]
    public class DataAwsDocdbEngineVersionConfig : aws.Documentdb.IDataAwsDocdbEngineVersionConfig
    {
