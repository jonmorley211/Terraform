...
namespace aws.Sfn
{
    ...
    public class SfnStateMachineConfig : aws.Sfn.ISfnStateMachineConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "loggingConfiguration", typeJson: "{\"fqn\":\"aws.sfn.SfnStateMachineLoggingConfiguration\"}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "tracingConfiguration", typeJson: "{\"fqn\":\"aws.sfn.SfnStateMachineTracingConfiguration\"}", isOptional: true, isOverride: true)]
