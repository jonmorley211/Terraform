...
{
    [JsiiInterface(nativeType: typeof(ICodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinear), fullyQualifiedName: "aws.codedeploy.CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinear")]
    public interface ICodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinear
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinear), fullyQualifiedName: "aws.codedeploy.CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinear")]
        internal sealed class _Proxy : DeputyBase, aws.Codedeploy.ICodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinear
        {
