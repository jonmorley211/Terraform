...
{
    [JsiiInterface(nativeType: typeof(ICodedeployDeploymentGroupAlarmConfiguration), fullyQualifiedName: "aws.codedeploy.CodedeployDeploymentGroupAlarmConfiguration")]
    public interface ICodedeployDeploymentGroupAlarmConfiguration
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICodedeployDeploymentGroupAlarmConfiguration), fullyQualifiedName: "aws.codedeploy.CodedeployDeploymentGroupAlarmConfiguration")]
        internal sealed class _Proxy : DeputyBase, aws.Codedeploy.ICodedeployDeploymentGroupAlarmConfiguration
        {
