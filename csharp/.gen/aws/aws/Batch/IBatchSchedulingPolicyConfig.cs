...
namespace aws.Batch
{
    ...
    [JsiiInterface(nativeType: typeof(IBatchSchedulingPolicyConfig), fullyQualifiedName: "aws.batch.BatchSchedulingPolicyConfig")]
    public interface IBatchSchedulingPolicyConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "fairSharePolicy", typeJson: "{\"fqn\":\"aws.batch.BatchSchedulingPolicyFairSharePolicy\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Batch.IBatchSchedulingPolicyFairSharePolicy? FairSharePolicy
        {
            get
            {
                return null;
        ...
        /// <summary>AWS Batch.</summary>
        [JsiiTypeProxy(nativeType: typeof(IBatchSchedulingPolicyConfig), fullyQualifiedName: "aws.batch.BatchSchedulingPolicyConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Batch.IBatchSchedulingPolicyConfig
        {
