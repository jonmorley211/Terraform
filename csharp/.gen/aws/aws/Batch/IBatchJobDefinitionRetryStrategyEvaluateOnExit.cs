...
namespace aws.Batch
{
    [JsiiInterface(nativeType: typeof(IBatchJobDefinitionRetryStrategyEvaluateOnExit), fullyQualifiedName: "aws.batch.BatchJobDefinitionRetryStrategyEvaluateOnExit")]
    public interface IBatchJobDefinitionRetryStrategyEvaluateOnExit
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBatchJobDefinitionRetryStrategyEvaluateOnExit), fullyQualifiedName: "aws.batch.BatchJobDefinitionRetryStrategyEvaluateOnExit")]
        internal sealed class _Proxy : DeputyBase, aws.Batch.IBatchJobDefinitionRetryStrategyEvaluateOnExit
        {
