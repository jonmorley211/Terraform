...
namespace aws.Lex
{
    [JsiiInterface(nativeType: typeof(ILexIntentFollowUpPromptRejectionStatementMessage), fullyQualifiedName: "aws.lex.LexIntentFollowUpPromptRejectionStatementMessage")]
    public interface ILexIntentFollowUpPromptRejectionStatementMessage
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILexIntentFollowUpPromptRejectionStatementMessage), fullyQualifiedName: "aws.lex.LexIntentFollowUpPromptRejectionStatementMessage")]
        internal sealed class _Proxy : DeputyBase, aws.Lex.ILexIntentFollowUpPromptRejectionStatementMessage
        {
