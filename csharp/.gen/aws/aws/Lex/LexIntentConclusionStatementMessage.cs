...
namespace aws.Lex
{
    ...
    [JsiiByValue(fqn: "aws.lex.LexIntentConclusionStatementMessage")]
    public class LexIntentConclusionStatementMessage : aws.Lex.ILexIntentConclusionStatementMessage
    {
