...
namespace aws.Lex
{
    [JsiiInterface(nativeType: typeof(ILexBotClarificationPromptMessage), fullyQualifiedName: "aws.lex.LexBotClarificationPromptMessage")]
    public interface ILexBotClarificationPromptMessage
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILexBotClarificationPromptMessage), fullyQualifiedName: "aws.lex.LexBotClarificationPromptMessage")]
        internal sealed class _Proxy : DeputyBase, aws.Lex.ILexBotClarificationPromptMessage
        {
