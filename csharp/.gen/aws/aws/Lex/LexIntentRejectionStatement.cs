...
namespace aws.Lex
{
    ...
    [JsiiByValue(fqn: "aws.lex.LexIntentRejectionStatement")]
    public class LexIntentRejectionStatement : aws.Lex.ILexIntentRejectionStatement
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "message", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.lex.LexIntentRejectionStatementMessage\"},\"kind\":\"array\"}}", isOverride: true)]
