...
namespace aws.Lex
{
    [JsiiInterface(nativeType: typeof(ILexIntentSlotValueElicitationPrompt), fullyQualifiedName: "aws.lex.LexIntentSlotValueElicitationPrompt")]
    public interface ILexIntentSlotValueElicitationPrompt
    {
        ...
        aws.Lex.ILexIntentSlotValueElicitationPromptMessage[] Message
        {
            get;
        }
        ...
        [JsiiTypeProxy(nativeType: typeof(ILexIntentSlotValueElicitationPrompt), fullyQualifiedName: "aws.lex.LexIntentSlotValueElicitationPrompt")]
        internal sealed class _Proxy : DeputyBase, aws.Lex.ILexIntentSlotValueElicitationPrompt
        {
            ...
            /// </remarks>
            [JsiiProperty(name: "message", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.lex.LexIntentSlotValueElicitationPromptMessage\"},\"kind\":\"array\"}}")]
            public aws.Lex.ILexIntentSlotValueElicitationPromptMessage[] Message
            {
