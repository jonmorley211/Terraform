...
namespace aws.Lex
{
    ...
    [JsiiByValue(fqn: "aws.lex.LexIntentFollowUpPromptRejectionStatementMessage")]
    public class LexIntentFollowUpPromptRejectionStatementMessage : aws.Lex.ILexIntentFollowUpPromptRejectionStatementMessage
    {
