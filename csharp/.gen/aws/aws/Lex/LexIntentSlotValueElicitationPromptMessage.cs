...
namespace aws.Lex
{
    ...
    [JsiiByValue(fqn: "aws.lex.LexIntentSlotValueElicitationPromptMessage")]
    public class LexIntentSlotValueElicitationPromptMessage : aws.Lex.ILexIntentSlotValueElicitationPromptMessage
    {
