...
namespace aws.Lex
{
    [JsiiInterface(nativeType: typeof(ILexIntentTimeouts), fullyQualifiedName: "aws.lex.LexIntentTimeouts")]
    public interface ILexIntentTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILexIntentTimeouts), fullyQualifiedName: "aws.lex.LexIntentTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Lex.ILexIntentTimeouts
        {
