...
namespace aws.Lex
{
    [JsiiInterface(nativeType: typeof(ILexSlotTypeTimeouts), fullyQualifiedName: "aws.lex.LexSlotTypeTimeouts")]
    public interface ILexSlotTypeTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILexSlotTypeTimeouts), fullyQualifiedName: "aws.lex.LexSlotTypeTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Lex.ILexSlotTypeTimeouts
        {
