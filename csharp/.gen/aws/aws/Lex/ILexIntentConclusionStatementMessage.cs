...
namespace aws.Lex
{
    [JsiiInterface(nativeType: typeof(ILexIntentConclusionStatementMessage), fullyQualifiedName: "aws.lex.LexIntentConclusionStatementMessage")]
    public interface ILexIntentConclusionStatementMessage
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILexIntentConclusionStatementMessage), fullyQualifiedName: "aws.lex.LexIntentConclusionStatementMessage")]
        internal sealed class _Proxy : DeputyBase, aws.Lex.ILexIntentConclusionStatementMessage
        {
