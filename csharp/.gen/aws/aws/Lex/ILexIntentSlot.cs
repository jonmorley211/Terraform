...
namespace aws.Lex
{
    [JsiiInterface(nativeType: typeof(ILexIntentSlot), fullyQualifiedName: "aws.lex.LexIntentSlot")]
    public interface ILexIntentSlot
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "valueElicitationPrompt", typeJson: "{\"fqn\":\"aws.lex.LexIntentSlotValueElicitationPrompt\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Lex.ILexIntentSlotValueElicitationPrompt? ValueElicitationPrompt
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ILexIntentSlot), fullyQualifiedName: "aws.lex.LexIntentSlot")]
        internal sealed class _Proxy : DeputyBase, aws.Lex.ILexIntentSlot
        {
