...
namespace aws.Lex
{
    ...
    [JsiiByValue(fqn: "aws.lex.LexIntentFollowUpPromptPrompt")]
    public class LexIntentFollowUpPromptPrompt : aws.Lex.ILexIntentFollowUpPromptPrompt
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "message", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.lex.LexIntentFollowUpPromptPromptMessage\"},\"kind\":\"array\"}}", isOverride: true)]
