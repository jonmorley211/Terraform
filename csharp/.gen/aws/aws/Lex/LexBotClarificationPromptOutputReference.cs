...
namespace aws.Lex
{
    [JsiiClass(nativeType: typeof(aws.Lex.LexBotClarificationPromptOutputReference), fullyQualifiedName: "aws.lex.LexBotClarificationPromptOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.ITerraformResource\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"True if this is a block, false if it's a list.\"},\"name\":\"isSingleItem\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class LexBotClarificationPromptOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LexBotClarificationPromptOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "messageInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.lex.LexBotClarificationPromptMessage\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Lex.ILexBotClarificationPromptMessage[]? MessageInput
        {
        ...
        public virtual aws.Lex.ILexBotClarificationPromptMessage[] Message
        {
            get => GetInstanceProperty<aws.Lex.ILexBotClarificationPromptMessage[]>()!;
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.lex.LexBotClarificationPrompt\"}", isOptional: true)]
        public virtual aws.Lex.ILexBotClarificationPrompt? InternalValue
        {
