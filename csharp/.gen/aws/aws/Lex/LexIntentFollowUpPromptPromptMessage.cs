...
namespace aws.Lex
{
    ...
    [JsiiByValue(fqn: "aws.lex.LexIntentFollowUpPromptPromptMessage")]
    public class LexIntentFollowUpPromptPromptMessage : aws.Lex.ILexIntentFollowUpPromptPromptMessage
    {
