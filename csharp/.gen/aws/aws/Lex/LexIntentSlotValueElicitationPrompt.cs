...
namespace aws.Lex
{
    ...
    [JsiiByValue(fqn: "aws.lex.LexIntentSlotValueElicitationPrompt")]
    public class LexIntentSlotValueElicitationPrompt : aws.Lex.ILexIntentSlotValueElicitationPrompt
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "message", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.lex.LexIntentSlotValueElicitationPromptMessage\"},\"kind\":\"array\"}}", isOverride: true)]
