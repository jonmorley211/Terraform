...
namespace aws.Lex
{
    [JsiiInterface(nativeType: typeof(ILexBotAliasConversationLogsLogSettings), fullyQualifiedName: "aws.lex.LexBotAliasConversationLogsLogSettings")]
    public interface ILexBotAliasConversationLogsLogSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILexBotAliasConversationLogsLogSettings), fullyQualifiedName: "aws.lex.LexBotAliasConversationLogsLogSettings")]
        internal sealed class _Proxy : DeputyBase, aws.Lex.ILexBotAliasConversationLogsLogSettings
        {
