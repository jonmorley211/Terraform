...
namespace aws.Cloudwatch
{
    ...
    [JsiiByValue(fqn: "aws.cloudwatch.CloudwatchMetricStreamExcludeFilter")]
    public class CloudwatchMetricStreamExcludeFilter : aws.Cloudwatch.ICloudwatchMetricStreamExcludeFilter
    {
