...
namespace aws.Storagegateway
{
    ...
    public interface IStoragegatewaySmbFileShareConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "cacheAttributes", typeJson: "{\"fqn\":\"aws.storagegateway.StoragegatewaySmbFileShareCacheAttributes\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Storagegateway.IStoragegatewaySmbFileShareCacheAttributes? CacheAttributes
        {
            get
            {
                return null;
