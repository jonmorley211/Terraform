...
namespace aws.Storagegateway
{
    ...
    public class StoragegatewaySmbFileShare : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiMethod(name: "putCacheAttributes", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.storagegateway.StoragegatewaySmbFileShareCacheAttributes\"}}]")]
        public virtual void PutCacheAttributes(aws.Storagegateway.IStoragegatewaySmbFileShareCacheAttributes @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.Storagegateway.IStoragegatewaySmbFileShareCacheAttributes)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "cacheAttributes", typeJson: "{\"fqn\":\"aws.storagegateway.StoragegatewaySmbFileShareCacheAttributesOutputReference\"}")]
        public virtual aws.Storagegateway.StoragegatewaySmbFileShareCacheAttributesOutputReference CacheAttributes
        {
            get => GetInstanceProperty<aws.Storagegateway.StoragegatewaySmbFileShareCacheAttributesOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "cacheAttributesInput", typeJson: "{\"fqn\":\"aws.storagegateway.StoragegatewaySmbFileShareCacheAttributes\"}", isOptional: true)]
        public virtual aws.Storagegateway.IStoragegatewaySmbFileShareCacheAttributes? CacheAttributesInput
        {
            get => GetInstanceProperty<aws.Storagegateway.IStoragegatewaySmbFileShareCacheAttributes?>();
        }
