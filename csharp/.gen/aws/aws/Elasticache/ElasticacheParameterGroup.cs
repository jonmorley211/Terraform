...
namespace aws.Elasticache
{
    ...
    public class ElasticacheParameterGroup : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "parameterInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.elasticache.ElasticacheParameterGroupParameter\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.Elasticache.IElasticacheParameterGroupParameter[]? ParameterInput
        {
            get => GetInstanceProperty<aws.Elasticache.IElasticacheParameterGroupParameter[]?>();
        }
        ...
        [JsiiProperty(name: "parameter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.elasticache.ElasticacheParameterGroupParameter\"},\"kind\":\"array\"}}")]
        public virtual aws.Elasticache.IElasticacheParameterGroupParameter[] Parameter
        {
            get => GetInstanceProperty<aws.Elasticache.IElasticacheParameterGroupParameter[]>()!;
            set => SetInstanceProperty(value);
        }
