...
namespace aws.Elasticache
{
    ...
    public class DataAwsElasticacheCluster : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiMethod(name: "cacheNodes", returnsJson: "{\"type\":{\"fqn\":\"aws.elasticache.DataAwsElasticacheClusterCacheNodes\"}}", parametersJson: "[{\"name\":\"index\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual aws.Elasticache.DataAwsElasticacheClusterCacheNodes CacheNodes(string index)
        {
            return InvokeInstanceMethod<aws.Elasticache.DataAwsElasticacheClusterCacheNodes>(new System.Type[]{typeof(string)}, new object[]{index})!;
        }
