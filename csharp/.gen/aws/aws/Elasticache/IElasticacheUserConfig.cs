...
namespace aws.Elasticache
{
    ...
    [JsiiInterface(nativeType: typeof(IElasticacheUserConfig), fullyQualifiedName: "aws.elasticache.ElasticacheUserConfig")]
    public interface IElasticacheUserConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS ElastiCache.</summary>
        [JsiiTypeProxy(nativeType: typeof(IElasticacheUserConfig), fullyQualifiedName: "aws.elasticache.ElasticacheUserConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Elasticache.IElasticacheUserConfig
        {
