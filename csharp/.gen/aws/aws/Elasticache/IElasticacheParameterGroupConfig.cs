...
namespace aws.Elasticache
{
    ...
    public interface IElasticacheParameterGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "parameter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.elasticache.ElasticacheParameterGroupParameter\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Elasticache.IElasticacheParameterGroupParameter[]? Parameter
        {
            get
            {
                return null;
