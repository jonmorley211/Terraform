...
namespace aws.Macie
{
    [JsiiClass(nativeType: typeof(aws.Macie.MacieS3BucketAssociationClassificationTypeOutputReference), fullyQualifiedName: "aws.macie.MacieS3BucketAssociationClassificationTypeOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.ITerraformResource\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"True if this is a block, false if it's a list.\"},\"name\":\"isSingleItem\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class MacieS3BucketAssociationClassificationTypeOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public MacieS3BucketAssociationClassificationTypeOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
