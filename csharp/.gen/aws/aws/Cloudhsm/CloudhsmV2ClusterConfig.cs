...
namespace aws.Cloudhsm
{
    ...
    public class CloudhsmV2ClusterConfig : aws.Cloudhsm.ICloudhsmV2ClusterConfig
    {
        ...
        [JsiiProperty(name: "hsmType", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "sourceBackupIdentifier", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.cloudhsm.CloudhsmV2ClusterTimeouts\"}", isOptional: true, isOverride: true)]
