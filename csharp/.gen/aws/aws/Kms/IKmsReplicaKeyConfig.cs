...
namespace aws.Kms
{
    ...
    [JsiiInterface(nativeType: typeof(IKmsReplicaKeyConfig), fullyQualifiedName: "aws.kms.KmsReplicaKeyConfig")]
    public interface IKmsReplicaKeyConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Key Management Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IKmsReplicaKeyConfig), fullyQualifiedName: "aws.kms.KmsReplicaKeyConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Kms.IKmsReplicaKeyConfig
        {
