...
namespace aws.Chime
{
    ...
    [JsiiByValue(fqn: "aws.chime.ChimeVoiceConnectorOriginationConfig")]
    public class ChimeVoiceConnectorOriginationConfig : aws.Chime.IChimeVoiceConnectorOriginationConfig
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "route", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.chime.ChimeVoiceConnectorOriginationRoute\"},\"kind\":\"array\"}}", isOverride: true)]
