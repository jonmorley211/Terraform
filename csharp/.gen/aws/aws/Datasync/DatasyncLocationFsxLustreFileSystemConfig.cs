...
namespace aws.Datasync
{
    ...
    [JsiiByValue(fqn: "aws.datasync.DatasyncLocationFsxLustreFileSystemConfig")]
    public class DatasyncLocationFsxLustreFileSystemConfig : aws.Datasync.IDatasyncLocationFsxLustreFileSystemConfig
    {
