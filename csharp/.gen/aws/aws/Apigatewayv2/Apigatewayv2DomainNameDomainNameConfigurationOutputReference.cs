...
namespace aws.Apigatewayv2
{
    ...
    public class Apigatewayv2DomainNameDomainNameConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public Apigatewayv2DomainNameDomainNameConfigurationOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
