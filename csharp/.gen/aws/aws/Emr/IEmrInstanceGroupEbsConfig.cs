...
namespace aws.Emr
{
    [JsiiInterface(nativeType: typeof(IEmrInstanceGroupEbsConfig), fullyQualifiedName: "aws.emr.EmrInstanceGroupEbsConfig")]
    public interface IEmrInstanceGroupEbsConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEmrInstanceGroupEbsConfig), fullyQualifiedName: "aws.emr.EmrInstanceGroupEbsConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Emr.IEmrInstanceGroupEbsConfig
        {
