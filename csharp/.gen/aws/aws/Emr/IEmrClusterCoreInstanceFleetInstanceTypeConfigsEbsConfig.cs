...
namespace aws.Emr
{
    [JsiiInterface(nativeType: typeof(IEmrClusterCoreInstanceFleetInstanceTypeConfigsEbsConfig), fullyQualifiedName: "aws.emr.EmrClusterCoreInstanceFleetInstanceTypeConfigsEbsConfig")]
    public interface IEmrClusterCoreInstanceFleetInstanceTypeConfigsEbsConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEmrClusterCoreInstanceFleetInstanceTypeConfigsEbsConfig), fullyQualifiedName: "aws.emr.EmrClusterCoreInstanceFleetInstanceTypeConfigsEbsConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Emr.IEmrClusterCoreInstanceFleetInstanceTypeConfigsEbsConfig
        {
