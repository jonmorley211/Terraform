...
namespace aws.Emr
{
    [JsiiInterface(nativeType: typeof(IEmrClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification), fullyQualifiedName: "aws.emr.EmrClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification")]
    public interface IEmrClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEmrClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification), fullyQualifiedName: "aws.emr.EmrClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification")]
        internal sealed class _Proxy : DeputyBase, aws.Emr.IEmrClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification
        {
