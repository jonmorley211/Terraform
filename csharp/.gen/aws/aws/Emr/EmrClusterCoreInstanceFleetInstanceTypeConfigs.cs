...
namespace aws.Emr
{
    ...
    [JsiiByValue(fqn: "aws.emr.EmrClusterCoreInstanceFleetInstanceTypeConfigs")]
    public class EmrClusterCoreInstanceFleetInstanceTypeConfigs : aws.Emr.IEmrClusterCoreInstanceFleetInstanceTypeConfigs
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "configurations", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.emr.EmrClusterCoreInstanceFleetInstanceTypeConfigsConfigurations\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "ebsConfig", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.emr.EmrClusterCoreInstanceFleetInstanceTypeConfigsEbsConfig\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
