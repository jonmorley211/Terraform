...
namespace aws.Emr
{
    [JsiiInterface(nativeType: typeof(IEmrClusterMasterInstanceFleetInstanceTypeConfigsEbsConfig), fullyQualifiedName: "aws.emr.EmrClusterMasterInstanceFleetInstanceTypeConfigsEbsConfig")]
    public interface IEmrClusterMasterInstanceFleetInstanceTypeConfigsEbsConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEmrClusterMasterInstanceFleetInstanceTypeConfigsEbsConfig), fullyQualifiedName: "aws.emr.EmrClusterMasterInstanceFleetInstanceTypeConfigsEbsConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Emr.IEmrClusterMasterInstanceFleetInstanceTypeConfigsEbsConfig
        {
