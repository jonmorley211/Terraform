...
namespace aws.Emr
{
    [JsiiInterface(nativeType: typeof(IEmrClusterCoreInstanceGroupEbsConfig), fullyQualifiedName: "aws.emr.EmrClusterCoreInstanceGroupEbsConfig")]
    public interface IEmrClusterCoreInstanceGroupEbsConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEmrClusterCoreInstanceGroupEbsConfig), fullyQualifiedName: "aws.emr.EmrClusterCoreInstanceGroupEbsConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Emr.IEmrClusterCoreInstanceGroupEbsConfig
        {
