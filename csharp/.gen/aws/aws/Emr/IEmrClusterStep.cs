...
namespace aws.Emr
{
    ...
    public interface IEmrClusterStep
    {
        ...
        [JsiiProperty(name: "hadoopJarStep", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.emr.EmrClusterStepHadoopJarStep\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Emr.IEmrClusterStepHadoopJarStep[]? HadoopJarStep
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, aws.Emr.IEmrClusterStep
        {
            ...
            {
                get => GetInstanceProperty<aws.Emr.IEmrClusterStepHadoopJarStep[]?>();
            }
