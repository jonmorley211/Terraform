...
namespace aws.Emr
{
    [JsiiInterface(nativeType: typeof(IEmrClusterMasterInstanceFleetLaunchSpecificationsSpotSpecification), fullyQualifiedName: "aws.emr.EmrClusterMasterInstanceFleetLaunchSpecificationsSpotSpecification")]
    public interface IEmrClusterMasterInstanceFleetLaunchSpecificationsSpotSpecification
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEmrClusterMasterInstanceFleetLaunchSpecificationsSpotSpecification), fullyQualifiedName: "aws.emr.EmrClusterMasterInstanceFleetLaunchSpecificationsSpotSpecification")]
        internal sealed class _Proxy : DeputyBase, aws.Emr.IEmrClusterMasterInstanceFleetLaunchSpecificationsSpotSpecification
        {
