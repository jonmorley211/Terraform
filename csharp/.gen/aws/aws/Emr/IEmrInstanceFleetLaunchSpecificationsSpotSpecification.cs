...
namespace aws.Emr
{
    [JsiiInterface(nativeType: typeof(IEmrInstanceFleetLaunchSpecificationsSpotSpecification), fullyQualifiedName: "aws.emr.EmrInstanceFleetLaunchSpecificationsSpotSpecification")]
    public interface IEmrInstanceFleetLaunchSpecificationsSpotSpecification
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEmrInstanceFleetLaunchSpecificationsSpotSpecification), fullyQualifiedName: "aws.emr.EmrInstanceFleetLaunchSpecificationsSpotSpecification")]
        internal sealed class _Proxy : DeputyBase, aws.Emr.IEmrInstanceFleetLaunchSpecificationsSpotSpecification
        {
