...
namespace aws.Emr
{
    ...
    public class EmrClusterEc2AttributesOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public EmrClusterEc2AttributesOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
