...
namespace aws.Wafv2
{
    ...
    public class Wafv2WebAclRuleStatementOrStatementStatementGeoMatchStatement : aws.Wafv2.IWafv2WebAclRuleStatementOrStatementStatementGeoMatchStatement
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "forwardedIpConfig", typeJson: "{\"fqn\":\"aws.wafv2.Wafv2WebAclRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig\"}", isOptional: true, isOverride: true)]
