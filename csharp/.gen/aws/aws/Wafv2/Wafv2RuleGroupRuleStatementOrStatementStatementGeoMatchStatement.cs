...
namespace aws.Wafv2
{
    ...
    public class Wafv2RuleGroupRuleStatementOrStatementStatementGeoMatchStatement : aws.Wafv2.IWafv2RuleGroupRuleStatementOrStatementStatementGeoMatchStatement
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "forwardedIpConfig", typeJson: "{\"fqn\":\"aws.wafv2.Wafv2RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig\"}", isOptional: true, isOverride: true)]
