...
namespace aws.Wafv2
{
    ...
    public class Wafv2RuleGroupRuleStatementGeoMatchStatement : aws.Wafv2.IWafv2RuleGroupRuleStatementGeoMatchStatement
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "forwardedIpConfig", typeJson: "{\"fqn\":\"aws.wafv2.Wafv2RuleGroupRuleStatementGeoMatchStatementForwardedIpConfig\"}", isOptional: true, isOverride: true)]
