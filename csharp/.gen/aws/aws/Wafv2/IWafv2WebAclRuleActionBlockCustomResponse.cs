...
namespace aws.Wafv2
{
    [JsiiInterface(nativeType: typeof(IWafv2WebAclRuleActionBlockCustomResponse), fullyQualifiedName: "aws.wafv2.Wafv2WebAclRuleActionBlockCustomResponse")]
    public interface IWafv2WebAclRuleActionBlockCustomResponse
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "responseHeader", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.wafv2.Wafv2WebAclRuleActionBlockCustomResponseResponseHeader\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Wafv2.IWafv2WebAclRuleActionBlockCustomResponseResponseHeader[]? ResponseHeader
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IWafv2WebAclRuleActionBlockCustomResponse), fullyQualifiedName: "aws.wafv2.Wafv2WebAclRuleActionBlockCustomResponse")]
        internal sealed class _Proxy : DeputyBase, aws.Wafv2.IWafv2WebAclRuleActionBlockCustomResponse
        {
