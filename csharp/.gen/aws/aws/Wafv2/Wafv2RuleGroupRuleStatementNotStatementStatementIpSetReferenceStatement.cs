...
namespace aws.Wafv2
{
    ...
    public class Wafv2RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatement : aws.Wafv2.IWafv2RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatement
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "ipSetForwardedIpConfig", typeJson: "{\"fqn\":\"aws.wafv2.Wafv2RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig\"}", isOptional: true, isOverride: true)]
