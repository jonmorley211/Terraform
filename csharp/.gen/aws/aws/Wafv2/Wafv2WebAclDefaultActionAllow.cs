...
namespace aws.Wafv2
{
    [JsiiByValue(fqn: "aws.wafv2.Wafv2WebAclDefaultActionAllow")]
    public class Wafv2WebAclDefaultActionAllow : aws.Wafv2.IWafv2WebAclDefaultActionAllow
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "customRequestHandling", typeJson: "{\"fqn\":\"aws.wafv2.Wafv2WebAclDefaultActionAllowCustomRequestHandling\"}", isOptional: true, isOverride: true)]
