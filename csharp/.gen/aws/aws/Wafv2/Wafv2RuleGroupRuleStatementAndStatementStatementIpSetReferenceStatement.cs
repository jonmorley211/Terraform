...
namespace aws.Wafv2
{
    ...
    public class Wafv2RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatement : aws.Wafv2.IWafv2RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatement
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "ipSetForwardedIpConfig", typeJson: "{\"fqn\":\"aws.wafv2.Wafv2RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig\"}", isOptional: true, isOverride: true)]
