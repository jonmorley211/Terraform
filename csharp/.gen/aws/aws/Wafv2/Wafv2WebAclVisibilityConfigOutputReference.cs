...
namespace aws.Wafv2
{
    ...
    public class Wafv2WebAclVisibilityConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public Wafv2WebAclVisibilityConfigOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
