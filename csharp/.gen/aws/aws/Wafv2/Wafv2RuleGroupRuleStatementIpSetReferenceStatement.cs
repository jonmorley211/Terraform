...
namespace aws.Wafv2
{
    ...
    public class Wafv2RuleGroupRuleStatementIpSetReferenceStatement : aws.Wafv2.IWafv2RuleGroupRuleStatementIpSetReferenceStatement
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "ipSetForwardedIpConfig", typeJson: "{\"fqn\":\"aws.wafv2.Wafv2RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig\"}", isOptional: true, isOverride: true)]
