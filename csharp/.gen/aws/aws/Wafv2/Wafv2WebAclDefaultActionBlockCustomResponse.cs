...
namespace aws.Wafv2
{
    ...
    [JsiiByValue(fqn: "aws.wafv2.Wafv2WebAclDefaultActionBlockCustomResponse")]
    public class Wafv2WebAclDefaultActionBlockCustomResponse : aws.Wafv2.IWafv2WebAclDefaultActionBlockCustomResponse
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "responseHeader", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.wafv2.Wafv2WebAclDefaultActionBlockCustomResponseResponseHeader\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
