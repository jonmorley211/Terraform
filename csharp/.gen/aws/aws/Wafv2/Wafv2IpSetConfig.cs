...
namespace aws.Wafv2
{
    ...
    public class Wafv2IpSetConfig : aws.Wafv2.IWafv2IpSetConfig
    {
        ...
        [JsiiProperty(name: "ipAddressVersion", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "addresses", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
