...
{
    [JsiiInterface(nativeType: typeof(IServicecatalogServiceActionDefinition), fullyQualifiedName: "aws.servicecatalog.ServicecatalogServiceActionDefinition")]
    public interface IServicecatalogServiceActionDefinition
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IServicecatalogServiceActionDefinition), fullyQualifiedName: "aws.servicecatalog.ServicecatalogServiceActionDefinition")]
        internal sealed class _Proxy : DeputyBase, aws.Servicecatalog.IServicecatalogServiceActionDefinition
        {
