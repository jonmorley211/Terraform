...
namespace aws.Servicecatalog
{
    ...
    [JsiiByValue(fqn: "aws.servicecatalog.DataAwsServicecatalogProductConfig")]
    public class DataAwsServicecatalogProductConfig : aws.Servicecatalog.IDataAwsServicecatalogProductConfig
    {
