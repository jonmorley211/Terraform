...
namespace aws.Servicecatalog
{
    ...
    public class ServicecatalogPortfolioTimeoutsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ServicecatalogPortfolioTimeoutsOutputReference(HashiCorp.Cdktf.ITerraformResource terraformResource, string terraformAttribute, bool isSingleItem): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute, isSingleItem}))
        {
        }
