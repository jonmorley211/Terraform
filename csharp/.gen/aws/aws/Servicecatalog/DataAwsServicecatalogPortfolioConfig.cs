...
namespace aws.Servicecatalog
{
    ...
    [JsiiByValue(fqn: "aws.servicecatalog.DataAwsServicecatalogPortfolioConfig")]
    public class DataAwsServicecatalogPortfolioConfig : aws.Servicecatalog.IDataAwsServicecatalogPortfolioConfig
    {
