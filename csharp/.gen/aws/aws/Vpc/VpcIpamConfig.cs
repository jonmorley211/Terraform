...
namespace aws.Vpc
{
    ...
    [JsiiByValue(fqn: "aws.vpc.VpcIpamConfig")]
    public class VpcIpamConfig : aws.Vpc.IVpcIpamConfig
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "operatingRegions", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.VpcIpamOperatingRegions\"},\"kind\":\"array\"}}", isOverride: true)]
