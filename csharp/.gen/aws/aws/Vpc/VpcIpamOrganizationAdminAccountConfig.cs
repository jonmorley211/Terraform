...
namespace aws.Vpc
{
    ...
    [JsiiByValue(fqn: "aws.vpc.VpcIpamOrganizationAdminAccountConfig")]
    public class VpcIpamOrganizationAdminAccountConfig : aws.Vpc.IVpcIpamOrganizationAdminAccountConfig
    {
        ...
        [JsiiProperty(name: "delegatedAdminAccountId", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
