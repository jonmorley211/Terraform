...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(ISecurityGroupEgress), fullyQualifiedName: "aws.vpc.SecurityGroupEgress")]
    public interface ISecurityGroupEgress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityGroupEgress), fullyQualifiedName: "aws.vpc.SecurityGroupEgress")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.ISecurityGroupEgress
        {
