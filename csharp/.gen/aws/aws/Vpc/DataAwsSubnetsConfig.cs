...
namespace aws.Vpc
{
    ...
    [JsiiByValue(fqn: "aws.vpc.DataAwsSubnetsConfig")]
    public class DataAwsSubnetsConfig : aws.Vpc.IDataAwsSubnetsConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DataAwsSubnetsFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
