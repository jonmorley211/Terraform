...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IDefaultSecurityGroupEgress), fullyQualifiedName: "aws.vpc.DefaultSecurityGroupEgress")]
    public interface IDefaultSecurityGroupEgress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDefaultSecurityGroupEgress), fullyQualifiedName: "aws.vpc.DefaultSecurityGroupEgress")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDefaultSecurityGroupEgress
        {
