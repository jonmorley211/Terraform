...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IVpcPeeringConnectionAccepterRequester), fullyQualifiedName: "aws.vpc.VpcPeeringConnectionAccepterRequester")]
    public interface IVpcPeeringConnectionAccepterRequester
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVpcPeeringConnectionAccepterRequester), fullyQualifiedName: "aws.vpc.VpcPeeringConnectionAccepterRequester")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IVpcPeeringConnectionAccepterRequester
        {
