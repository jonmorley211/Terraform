...
namespace aws.Vpc
{
    ...
    public class DataAwsSubnetIdsConfig : aws.Vpc.IDataAwsSubnetIdsConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DataAwsSubnetIdsFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        public aws.Vpc.IDataAwsSubnetIdsFilter[]? Filter
        {
            get;
            set;
        }
