...
namespace aws.Vpc
{
    ...
    public class RouteTableConfig : aws.Vpc.IRouteTableConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "route", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.RouteTableRoute\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        public aws.Vpc.IRouteTableRoute[]? Route
        {
            get;
            set;
        }
        ...
        /// <summary>Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/route_table#tags_all RouteTable#tags_all}.</summary>
        [JsiiOptional]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.vpc.RouteTableTimeouts\"}", isOptional: true, isOverride: true)]
        public aws.Vpc.IRouteTableTimeouts? Timeouts
        {
            get;
            set;
        }
