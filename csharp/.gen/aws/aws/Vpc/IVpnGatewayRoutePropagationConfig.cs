...
namespace aws.Vpc
{
    ...
    public interface IVpnGatewayRoutePropagationConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.vpc.VpnGatewayRoutePropagationTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Vpc.IVpnGatewayRoutePropagationTimeouts? Timeouts
        {
            get
            {
                return null;
