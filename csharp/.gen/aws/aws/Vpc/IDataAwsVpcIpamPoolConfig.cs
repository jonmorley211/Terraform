...
namespace aws.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsVpcIpamPoolConfig), fullyQualifiedName: "aws.vpc.DataAwsVpcIpamPoolConfig")]
    public interface IDataAwsVpcIpamPoolConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DataAwsVpcIpamPoolFilter\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Vpc.IDataAwsVpcIpamPoolFilter[]? Filter
        {
            get
            {
                return null;
        ...
        /// <summary>AWS VPC.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsVpcIpamPoolConfig), fullyQualifiedName: "aws.vpc.DataAwsVpcIpamPoolConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDataAwsVpcIpamPoolConfig
        {
