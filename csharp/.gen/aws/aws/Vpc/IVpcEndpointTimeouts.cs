...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IVpcEndpointTimeouts), fullyQualifiedName: "aws.vpc.VpcEndpointTimeouts")]
    public interface IVpcEndpointTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVpcEndpointTimeouts), fullyQualifiedName: "aws.vpc.VpcEndpointTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IVpcEndpointTimeouts
        {
