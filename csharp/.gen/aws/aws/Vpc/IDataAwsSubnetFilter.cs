...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IDataAwsSubnetFilter), fullyQualifiedName: "aws.vpc.DataAwsSubnetFilter")]
    public interface IDataAwsSubnetFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsSubnetFilter), fullyQualifiedName: "aws.vpc.DataAwsSubnetFilter")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDataAwsSubnetFilter
        {
