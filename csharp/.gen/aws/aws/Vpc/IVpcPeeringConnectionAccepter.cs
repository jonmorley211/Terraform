...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IVpcPeeringConnectionAccepter), fullyQualifiedName: "aws.vpc.VpcPeeringConnectionAccepter")]
    public interface IVpcPeeringConnectionAccepter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVpcPeeringConnectionAccepter), fullyQualifiedName: "aws.vpc.VpcPeeringConnectionAccepter")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IVpcPeeringConnectionAccepter
        {
