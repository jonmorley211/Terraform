...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IDataAwsVpcFilter), fullyQualifiedName: "aws.vpc.DataAwsVpcFilter")]
    public interface IDataAwsVpcFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsVpcFilter), fullyQualifiedName: "aws.vpc.DataAwsVpcFilter")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDataAwsVpcFilter
        {
