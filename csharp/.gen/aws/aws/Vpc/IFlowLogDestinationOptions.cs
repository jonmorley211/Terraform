...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IFlowLogDestinationOptions), fullyQualifiedName: "aws.vpc.FlowLogDestinationOptions")]
    public interface IFlowLogDestinationOptions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IFlowLogDestinationOptions), fullyQualifiedName: "aws.vpc.FlowLogDestinationOptions")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IFlowLogDestinationOptions
        {
