...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IDefaultNetworkAclIngress), fullyQualifiedName: "aws.vpc.DefaultNetworkAclIngress")]
    public interface IDefaultNetworkAclIngress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDefaultNetworkAclIngress), fullyQualifiedName: "aws.vpc.DefaultNetworkAclIngress")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDefaultNetworkAclIngress
        {
