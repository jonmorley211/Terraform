...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(ISecurityGroupIngress), fullyQualifiedName: "aws.vpc.SecurityGroupIngress")]
    public interface ISecurityGroupIngress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityGroupIngress), fullyQualifiedName: "aws.vpc.SecurityGroupIngress")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.ISecurityGroupIngress
        {
