...
namespace aws.Vpc
{
    ...
    public class NetworkAclConfig : aws.Vpc.INetworkAclConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "egress", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.NetworkAclEgress\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        public aws.Vpc.INetworkAclEgress[]? Egress
        {
            get;
            set;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ingress", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.NetworkAclIngress\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        public aws.Vpc.INetworkAclIngress[]? Ingress
        {
            get;
            set;
        }
        ...
        /// <summary>Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/network_acl#tags_all NetworkAcl#tags_all}.</summary>
        [JsiiOptional]
