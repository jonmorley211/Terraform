...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IDefaultNetworkAclEgress), fullyQualifiedName: "aws.vpc.DefaultNetworkAclEgress")]
    public interface IDefaultNetworkAclEgress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDefaultNetworkAclEgress), fullyQualifiedName: "aws.vpc.DefaultNetworkAclEgress")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDefaultNetworkAclEgress
        {
