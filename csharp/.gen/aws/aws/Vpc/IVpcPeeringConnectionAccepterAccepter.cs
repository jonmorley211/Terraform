...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IVpcPeeringConnectionAccepterAccepter), fullyQualifiedName: "aws.vpc.VpcPeeringConnectionAccepterAccepter")]
    public interface IVpcPeeringConnectionAccepterAccepter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVpcPeeringConnectionAccepterAccepter), fullyQualifiedName: "aws.vpc.VpcPeeringConnectionAccepterAccepter")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IVpcPeeringConnectionAccepterAccepter
        {
