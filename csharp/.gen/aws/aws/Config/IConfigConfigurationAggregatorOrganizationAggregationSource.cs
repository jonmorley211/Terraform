...
{
    [JsiiInterface(nativeType: typeof(IConfigConfigurationAggregatorOrganizationAggregationSource), fullyQualifiedName: "aws.config.ConfigConfigurationAggregatorOrganizationAggregationSource")]
    public interface IConfigConfigurationAggregatorOrganizationAggregationSource
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IConfigConfigurationAggregatorOrganizationAggregationSource), fullyQualifiedName: "aws.config.ConfigConfigurationAggregatorOrganizationAggregationSource")]
        internal sealed class _Proxy : DeputyBase, aws.Config.IConfigConfigurationAggregatorOrganizationAggregationSource
        {
