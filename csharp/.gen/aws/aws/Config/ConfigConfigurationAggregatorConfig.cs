...
namespace aws.Config
{
    ...
    public class ConfigConfigurationAggregatorConfig : aws.Config.IConfigConfigurationAggregatorConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "accountAggregationSource", typeJson: "{\"fqn\":\"aws.config.ConfigConfigurationAggregatorAccountAggregationSource\"}", isOptional: true, isOverride: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "organizationAggregationSource", typeJson: "{\"fqn\":\"aws.config.ConfigConfigurationAggregatorOrganizationAggregationSource\"}", isOptional: true, isOverride: true)]
