...
{
    [JsiiInterface(nativeType: typeof(IConfigConfigRuleScope), fullyQualifiedName: "aws.config.ConfigConfigRuleScope")]
    public interface IConfigConfigRuleScope
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IConfigConfigRuleScope), fullyQualifiedName: "aws.config.ConfigConfigRuleScope")]
        internal sealed class _Proxy : DeputyBase, aws.Config.IConfigConfigRuleScope
        {
