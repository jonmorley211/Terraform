...
{
    [JsiiInterface(nativeType: typeof(IConfigOrganizationCustomRuleTimeouts), fullyQualifiedName: "aws.config.ConfigOrganizationCustomRuleTimeouts")]
    public interface IConfigOrganizationCustomRuleTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IConfigOrganizationCustomRuleTimeouts), fullyQualifiedName: "aws.config.ConfigOrganizationCustomRuleTimeouts")]
        internal sealed class _Proxy : DeputyBase, aws.Config.IConfigOrganizationCustomRuleTimeouts
        {
