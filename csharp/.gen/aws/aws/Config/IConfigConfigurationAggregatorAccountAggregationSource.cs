...
{
    [JsiiInterface(nativeType: typeof(IConfigConfigurationAggregatorAccountAggregationSource), fullyQualifiedName: "aws.config.ConfigConfigurationAggregatorAccountAggregationSource")]
    public interface IConfigConfigurationAggregatorAccountAggregationSource
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IConfigConfigurationAggregatorAccountAggregationSource), fullyQualifiedName: "aws.config.ConfigConfigurationAggregatorAccountAggregationSource")]
        internal sealed class _Proxy : DeputyBase, aws.Config.IConfigConfigurationAggregatorAccountAggregationSource
        {
